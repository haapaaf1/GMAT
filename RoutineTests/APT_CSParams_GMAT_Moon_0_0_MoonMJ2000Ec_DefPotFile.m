...
%%%GMAT Moon2Body.Gravity.Luna.PotentialFile = LP165P.cof;
...
GMAT Moon_Report.Filename = APT_CSParams_GMAT_Moon_0_0_MoonMJ2000Ec_DefPotFile.report;
...
GMAT XYPlot1.XVariable = MoonSC.A1ModJulian;
GMAT XYPlot1.YVariables = {MoonSC.EarthMJ2000Ec.X, MoonSC.EarthMJ2000Ec.Y, MoonSC.EarthMJ2000Ec.Z};
GMAT XYPlot1.ShowGrid = true;
GMAT XYPlot1.SolverIterations = None;
GMAT XYPlot1.ShowPlot = true;

Create XYPlot XYPlot2;
GMAT XYPlot2.XVariable = MoonSC.A1ModJulian;
GMAT XYPlot2.YVariables = {MoonSC.MoonMJ2000Ec.HX, MoonSC.MoonMJ2000Ec.HY, MoonSC.MoonMJ2000Ec.HZ};
...
GMAT OpenGLPlot1.CoordinateSystem = MoonMJ2000Ec;
GMAT OpenGLPlot1.ViewPointReference = Luna;
GMAT OpenGLPlot1.ViewPointVector = [ 0 0 30000];
GMAT OpenGLPlot1.ViewDirection = Luna;
GMAT OpenGLPlot1.ViewScaleFactor = 0.5;
GMAT OpenGLPlot1.ViewUpCoordinateSystem = MoonMJ2000Ec;
