...
%%GMAT SolarSystem.Luna.UsePotentialFileFlag = false; 
...
GMAT Moon_Report.Filename = APT_CSParams_GMAT_Moon_2Body_MoonFixed.report;
...
GMAT XYPlot1.YVariables = {MoonSC.EarthMJ2000Eq.X, MoonSC.EarthMJ2000Eq.Y, MoonSC.EarthMJ2000Eq.Z};
...
GMAT XYPlot2.YVariables = {MoonSC.EarthMJ2000Eq.HX, MoonSC.EarthMJ2000Eq.HY, MoonSC.EarthMJ2000Eq.HZ};
