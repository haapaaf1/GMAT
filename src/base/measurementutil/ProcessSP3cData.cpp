...
const std::string ProcessSP3cData::DATATYPE_DESCRIPTIONS[EndSP3cTypeReps] =
{
    "GPS",
    "MIXED",
    "GLONASS",
...
const std::string ProcessSP3cData::TIMESYSTEM_DESCRIPTIONS[EndSP3cTimeReps] =
{
    "GPS",
    "GLONASS",
    "GALILEO",
 ...
 */
//------------------------------------------------------------------------------
const std::string* ProcessSP3cData::GetDataTypes() const
{
 ...
 */
//------------------------------------------------------------------------------
std::string ProcessSP3cData::GetDataTypeText(const Integer &id) const
{
 ...
 */
//------------------------------------------------------------------------------
Integer ProcessSP3cData::GetDataTypeID(const std::string &label)
{
    return -1;
}
 ...
 */
//------------------------------------------------------------------------------
const std::string* ProcessSP3cData::GetTimeSystems() const
{
 ...
 */
//------------------------------------------------------------------------------
std::string ProcessSP3cData::GetTimeSystemText(const Integer &id) const
{
 ...
 */
//------------------------------------------------------------------------------
Integer ProcessSP3cData::GetTimeSystemID(const std::string &label)
{
    return -1;
}