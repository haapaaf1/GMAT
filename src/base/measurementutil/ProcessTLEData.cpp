...
//  static data
//---------------------------------
const std::string ProcessTLEData::DATATYPE_DESCRIPTIONS[EndTLETypeReps] =
{
    "Bstar",
    "Inclination",
    "RAAN",
...
const std::string ProcessTLEData::TIMESYSTEM_DESCRIPTIONS[EndTLETimeReps] =
{
    "UT"
};
 ...
 */
//------------------------------------------------------------------------------
const std::string* ProcessTLEData::GetDataTypes() const
{
 ...
 */
//------------------------------------------------------------------------------
std::string ProcessTLEData::GetDataTypeText(const Integer &id) const
{
 ...
 */
//------------------------------------------------------------------------------
Integer ProcessTLEData::GetDataTypeID(const std::string &label)
{
    return -1;
}
 ...
 */
//------------------------------------------------------------------------------
const std::string* ProcessTLEData::GetTimeSystems() const
{
 ...
 */
//------------------------------------------------------------------------------
std::string ProcessTLEData::GetTimeSystemText(const Integer &id) const
{
 ...
 */
//------------------------------------------------------------------------------
Integer ProcessTLEData::GetTimeSystemID(const std::string &label)
{
    return -1;
}