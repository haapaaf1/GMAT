...
//------------------------------------------------------------------------------
/**
 * Constructs base SLRDataFile structures 
 */
SLRDataFile::SLRDataFile(const std::string &itsName) :
...
//------------------------------------------------------------------------------
//  SLRDataFile::SLRDataFile()
//------------------------------------------------------------------------------
/**
 * Copy constructor for SLRDataFile objects
 */
//------------------------------------------------------------------------------
SLRDataFile::SLRDataFile(const SLRDataFile &SLRdf) :
        DataFile      (SLRdf),
...
//------------------------------------------------------------------------------
/**
 * Operator = constructor for SLRDataFile objects
 */
//------------------------------------------------------------------------------
const SLRDataFile& SLRDataFile::operator=(const SLRDataFile &SLRdf)
{
    if (&SLRdf == this)
	return *this;
 ...
 */
//------------------------------------------------------------------------------
GmatBase* SLRDataFile::Clone() const
{
   GmatBase *clone = new SLRDataFile(*this);
   return (clone);
}
 ...
 */
//---------------------------------------------------------------------------
bool SLRDataFile::IsParameterReadOnly(const Integer id) const
{
 ...
 */
//---------------------------------------------------------------------------
bool SLRDataFile::IsParameterReadOnly(const std::string &label) const
{
...
bool SLRDataFile::Initialize()
{
    ...
    if (pcrecpp::RE("^[Rr].*").FullMatch(readWriteMode))
    {
	    ...
	    // Now check for headers and  data accordingly
            if (GetData(mySLR))
 ...
 */
//------------------------------------------------------------------------------
bool SLRDataFile::GetData(ObType *mySLRData)
{
 ...
 */
//------------------------------------------------------------------------------
bool SLRDataFile::GetSLRHeader(std::string lff, 
...
//
//------------------------------------------------------------------------------
bool SLRDataFile::GetSLRData(std::string lff, SLRObType *mySLRdata)
{
    // Temporary variables for string to number conversion.
    // This is needed because the from_string utility function
    // only supports the standard C++ types and does not 
 ...
 */
//------------------------------------------------------------------------------
bool SLRDataFile::WriteDataHeader(const ObType *mySLRData)
{
 ...
 */
//------------------------------------------------------------------------------
bool SLRDataFile::WriteData(const ObType *mySLRData)
{
