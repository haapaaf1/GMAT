...
//------------------------------------------------------------------------------
/**
 * Constructs base TLEDataFile structures 
 */
TLEDataFile::TLEDataFile(const std::string &itsName) :
...
//------------------------------------------------------------------------------
/**
 * Copy constructor for TLEDataFile objects
 */
//------------------------------------------------------------------------------
TLEDataFile::TLEDataFile(const TLEDataFile &TLEdf) :
    DataFile      (TLEdf)
{
}
...
//------------------------------------------------------------------------------
/**
 * Operator = constructor for TLEDataFile objects
 */
//------------------------------------------------------------------------------
const TLEDataFile& TLEDataFile::operator=(const TLEDataFile &TLEdf)
{
    if (&TLEdf == this)
	return *this;
...
//------------------------------------------------------------------------------
/**
 * This method returns a clone of the TLEDataFile.
 *
 * @return clone of the TLEDataFile.
 */
//------------------------------------------------------------------------------
GmatBase* TLEDataFile::Clone() const
{
   GmatBase *clone = new TLEDataFile(*this);
   return (clone);
}
 ...
 */
//---------------------------------------------------------------------------
bool TLEDataFile::IsParameterReadOnly(const Integer id) const
{
 ...
 */
//---------------------------------------------------------------------------
bool TLEDataFile::IsParameterReadOnly(const std::string &label) const
{
 ...
 */
//------------------------------------------------------------------------------
bool TLEDataFile::GetData(ObType *myTLEData)
{
 ...
 */
//------------------------------------------------------------------------------
bool TLEDataFile::GetTLEData(std::string &lff, std::string &lff2,
				TLEObType *myTLEdata)
{
 ...
 */
//------------------------------------------------------------------------------
bool TLEDataFile::WriteData(const ObType *myTLEData)
{
