 ...
 */
//------------------------------------------------------------------------------
void CCSDSOPMObType::SetMetaData(CCSDSOPMMetaData *myCCSDSMetaData)
{
 ...
 */
//------------------------------------------------------------------------------
CCSDSOPMMetaData* CCSDSOPMObType::GetMetaData()
{
 ...
 */
//------------------------------------------------------------------------------
void CCSDSOPMObType::SetStateVector(CCSDSOPMStateVector *myOPMStateVector)
{
 ...
 */
//------------------------------------------------------------------------------
CCSDSOPMStateVector* CCSDSOPMObType::GetStateVector()
{
 ...
 */
//------------------------------------------------------------------------------
void CCSDSOPMObType::SetKeplerianElements(CCSDSKeplerianElements *myOPMKeplerianElements)
{
 ...
 */
//------------------------------------------------------------------------------
CCSDSKeplerianElements* CCSDSOPMObType::GetKeplerianElements()
{
 ...
 */
//------------------------------------------------------------------------------
void CCSDSOPMObType::SetSpacecraftParameters(CCSDSSpacecraftParameters *mySpacecraftParameters)
{
 ...
 */
//------------------------------------------------------------------------------
CCSDSSpacecraftParameters* CCSDSOPMObType::GetSpacecraftParameters()
{
 ...
 */
//------------------------------------------------------------------------------
void CCSDSOPMObType::AddManeuver(CCSDSManeuver *myManeuver)
{
 ...
 */
//------------------------------------------------------------------------------
CCSDSManeuver* CCSDSOPMObType::GetCurrentManeuver()
{
 ...
 */
//------------------------------------------------------------------------------
void CCSDSOPMObType::AdvanceToNextManeuver()
{
   i_ccsdsOPMManeuvers++;
}
 ...
 */
//------------------------------------------------------------------------------
void CCSDSOPMObType::BackupToPreviousManeuver()
{
   i_ccsdsOPMManeuvers--;
}
