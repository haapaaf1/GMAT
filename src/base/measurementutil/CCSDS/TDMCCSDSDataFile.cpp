 ...
 */
//------------------------------------------------------------------------------
bool TDMCCSDSDataFile::Initialize()
{
    ...
    if (pcrecpp::RE("^[Rr].*").FullMatch(readWriteMode))
    {
        ...
        TDMCCSDSObType *myTDM = new TDMCCSDSObType;
        ...
        i_theData = theData.begin();
            ...
            TDMCCSDSDataFile myOutFile("theFile");
 ...
 */
//------------------------------------------------------------------------------
TDMCCSDSDataFile::TDMCCSDSDataFile(const std::string &itsName) :
	CCSDSDataFile ("TDMCCSDSDataFile", itsName)
{
   objectTypeNames.push_back("TDMCCSDSDataFile");
   fileFormatName = "TDM";
   fileFormatID = 7;
   numLines = 1;
}
...
//------------------------------------------------------------------------------
//  TDMCCSDSDataFile::TDMCCSDSDataFile()
//------------------------------------------------------------------------------
/**
 * Copy constructor for CCSDSDataFile objects
 */
//------------------------------------------------------------------------------
TDMCCSDSDataFile::TDMCCSDSDataFile(const TDMCCSDSDataFile &CCSDSTDMdf) :
    CCSDSDataFile(CCSDSTDMdf)
{
}
 ...
 */
//------------------------------------------------------------------------------
const TDMCCSDSDataFile& TDMCCSDSDataFile::operator=(const TDMCCSDSDataFile &CCSDSTDMdf)
{
    if (&CCSDSTDMdf == this)
	return *this;

    CCSDSDataFile::operator=(CCSDSTDMdf);
...
//------------------------------------------------------------------------------
/**
 * This method returns a clone of the CCSDSDataFile.
 *
 * @return clone of the CCSDSDataFile.
 */
//------------------------------------------------------------------------------
GmatBase* TDMCCSDSDataFile::Clone() const
{
   GmatBase *clone = new TDMCCSDSDataFile(*this);
   return (clone);
}
 ...
 */
//---------------------------------------------------------------------------
bool TDMCCSDSDataFile::IsParameterReadOnly(const Integer id) const
{
 ...
 */
//---------------------------------------------------------------------------
bool TDMCCSDSDataFile::IsParameterReadOnly(const std::string &label) const
{
 ...
 */
//------------------------------------------------------------------------------
bool TDMCCSDSDataFile::GetData(ObType *myTDMData)
{
    
    if (!pcrecpp::RE("^TDMCCSDSObType").FullMatch(myTDMData->GetTypeName()))
        return false;

    // Re-cast the generic ObType pointer as a CCSDSTDMObtype pointer
    TDMCCSDSObType *myTDM = (TDMCCSDSObType*)myTDMData;
	...
	else
	{
        ...
        do
        {
            ...
            myTDM->ccsdsMetaData = (TDMCCSDSMetaData*)currentCCSDSMetaData;
...
//------------------------------------------------------------------------------
// bool GetCCSDSTDMData(std::string &lff, TrackingCCSDSData *myData,
//                      CCSDSObType *myOb)
//------------------------------------------------------------------------------
/**
...
//
//------------------------------------------------------------------------------
bool TDMCCSDSDataFile::GetCCSDSTDMData(std::string &lff,
                                              TDMCCSDSObType *myOb)
{
    ...
    TrackingCCSDSData *myTDMData = new TrackingCCSDSData;
...
//
//------------------------------------------------------------------------------
bool TDMCCSDSDataFile::GetCCSDSMetaData(std::string &lff,
                                TDMCCSDSObType *myOb)
{
    ...
    TDMCCSDSMetaData *myMetaData = new TDMCCSDSMetaData;
