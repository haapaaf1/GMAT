...
//  static data
//---------------------------------
const std::string OPMCCSDSMetaData::CCSDS_OPM_METADATA_KEYWORDS[EndOPMCCSDSMetaDataReps] =
{
    "OBJECT_NAME",
    "OBJECT_ID",
    "CENTER_NAME",
...
const std::string OPMCCSDSMetaData::CCSDS_METADATA_UNIT_DESCRIPTIONS[EndOPMCCSDSMetaDataReps] =
{
    "",
    "",
    "",
...
const std::string OPMCCSDSMetaData::CCSDS_METADATA_FILEFORMAT_DESCRIPTIONS[EndOPMCCSDSMetaDataReps] =
{
    "Object Name"
    "Object ID",
...
const bool OPMCCSDSMetaData::CCSDS_METADATA_IS_REQUIRED[EndOPMCCSDSMetaDataReps] =
{
    true,
    true,
    true,
...
const Gmat::ParameterType OPMCCSDSMetaData::CCSDS_METADATA_PARAMETER_TYPE[EndOPMCCSDSMetaDataReps] =
{
    Gmat::STRING_TYPE,
    Gmat::STRING_TYPE,
    Gmat::STRING_TYPE,
...
//------------------------------------------------------------------------------
/**
 * Constructor for the OPMCCSDSMetaData class
 */
//------------------------------------------------------------------------------
OPMCCSDSMetaData::OPMCCSDSMetaData() : CCSDSMetaData(),
 ...
 */
//------------------------------------------------------------------------------
OPMCCSDSMetaData::OPMCCSDSMetaData(const OPMCCSDSMetaData &opmMD) :
    CCSDSMetaData(opmMD),
...
//---------------------------------------------------------------------------
//  OPMCCSDSMetaData& operator= (const OPMCCSDSMetaData &opmMD)
//---------------------------------------------------------------------------
/**
 * Assignment operator for OPMCCSDSMetaData structures.
 *
...
//------------------------------------------------------------------------------
/**
 * Destructor for the OPMCCSDSMetaData class
 */
//------------------------------------------------------------------------------
OPMCCSDSMetaData::~OPMCCSDSMetaData()
{
}
 ...
 */
//------------------------------------------------------------------------------
const std::string* OPMCCSDSMetaData::GetKeywords() const
{
 ...
 */
//------------------------------------------------------------------------------
const Integer OPMCCSDSMetaData::GetKeywordID(const std::string str) const
{

    std::string regex = "^" + str + "$";

    for (Integer i = 0; i < EndOPMCCSDSMetaDataReps; i++)
    {
 ...
 */
//------------------------------------------------------------------------------
std::string OPMCCSDSMetaData::GetUnits(const Integer &id) const
{
 ...
 */
//---------------------------------------------------------------------------
bool OPMCCSDSMetaData::IsParameterRequired(const Integer id) const
{
    if (id >= 0 && id <= EndOPMCCSDSMetaDataReps)
...
Integer CountRequiredNumberOPMMetaDataParameters()
{
    ...
    for (Integer id = 0; id < OPMCCSDSMetaData::EndOPMCCSDSMetaDataReps; id++)
        if (OPMCCSDSMetaData::CCSDS_METADATA_IS_REQUIRED[id])
            num++;
 ...
 */
//------------------------------------------------------------------------------
std::string OPMCCSDSMetaData::GetDataParameterText(const Integer id) const
{
   if ((id >= 0) && (id < EndOPMCCSDSMetaDataReps))
   {
 ...
 */
//------------------------------------------------------------------------------
Integer OPMCCSDSMetaData::GetDataParameterID(const std::string &str) const
{
    std::string regex = "^" + str + "$";
 ...
 */
//------------------------------------------------------------------------------
Gmat::ParameterType OPMCCSDSMetaData::GetDataParameterType(const Integer id) const
{
   if ((id >= 0) && (id < EndOPMCCSDSMetaDataReps))
 ...
 */
//---------------------------------------------------------------------------
std::string OPMCCSDSMetaData::GetDataParameterTypeString(const Integer id) const
{
 ...
 */
//------------------------------------------------------------------------------
std::string OPMCCSDSMetaData::GetStringDataParameter(const Integer id) const
{
    switch (id)
    {
 ...
 */
//------------------------------------------------------------------------------
std::string OPMCCSDSMetaData::GetStringDataParameter(const std::string &label) const
{
 ...
 */
//------------------------------------------------------------------------------
StringArray OPMCCSDSMetaData::GetStringArrayDataParameter(const Integer id) const
{
    switch (id)
    {
 ...
 */
//---------------------------------------------------------------------------
bool OPMCCSDSMetaData::Validate() const
{

    for (unsigned int i = 0; i < EndOPMCCSDSMetaDataReps; i++ )
    {
...
//------------------------------------------------------------------------------
// std::ostream& operator<< (std::ostream &output, const OPMCCSDSMetaData *myMetaData)
//------------------------------------------------------------------------------
/**
...
std::ostream& operator<< (std::ostream &output, const OPMCCSDSMetaData *myMetaData)
{
   ...
   for (unsigned int i = 0; i < myMetaData->comments.size(); i++ )
   {
    ...
    for (unsigned int i = 0; i < OPMCCSDSMetaData::EndOPMCCSDSMetaDataReps; i++)
    {
