 ...
 */
//------------------------------------------------------------------------------
bool APMCCSDSDataFile::Initialize()
{
    ...
    if (pcrecpp::RE("^[Rr].*").FullMatch(readWriteMode))
    {
        ...
        APMCCSDSObType *myAPM = new APMCCSDSObType;
        ...
        i_theData = theData.begin();
            ...
            APMCCSDSDataFile myOutFile("theFile");
...
//------------------------------------------------------------------------------
/**
 * Constructs base APMCCSDSDataFile structures
 */
//------------------------------------------------------------------------------
APMCCSDSDataFile::APMCCSDSDataFile(const std::string &itsName) :
	CCSDSDataFile ("APMCCSDSDataFile", itsName)
{
   objectTypeNames.push_back("APMCCSDSDataFile");
   fileFormatName = "APM";
   fileFormatID = 10;
   numLines = 1;
}
...
//------------------------------------------------------------------------------
//  APMCCSDSDataFile::APMCCSDSDataFile()
//------------------------------------------------------------------------------
/**
 * Copy constructor for APMCCSDSDataFile objects
 */
//------------------------------------------------------------------------------
APMCCSDSDataFile::APMCCSDSDataFile(const APMCCSDSDataFile &CCSDSAPMdf) :
    CCSDSDataFile(CCSDSAPMdf)
{
}
...
//------------------------------------------------------------------------------
/**
 * Operator = constructor for APMCCSDSDataFile objects
 */
//------------------------------------------------------------------------------
const APMCCSDSDataFile& APMCCSDSDataFile::operator=(const APMCCSDSDataFile &CCSDSAPMdf)
{
    if (&CCSDSAPMdf == this)
	return *this;

    CCSDSDataFile::operator=(CCSDSAPMdf);
    return *this;
}
...
//------------------------------------------------------------------------------
/**
 * This method returns a clone of the APMCCSDSDataFile.
 *
 * @return clone of the APMCCSDSDataFile.
 */
//------------------------------------------------------------------------------
GmatBase* APMCCSDSDataFile::Clone() const
{
   GmatBase *clone = new APMCCSDSDataFile(*this);
   return (clone);
}
 ...
 */
//---------------------------------------------------------------------------
bool APMCCSDSDataFile::IsParameterReadOnly(const Integer id) const
{
 ...
 */
//---------------------------------------------------------------------------
bool APMCCSDSDataFile::IsParameterReadOnly(const std::string &label) const
{
 ...
 */
//------------------------------------------------------------------------------
bool APMCCSDSDataFile::GetData(ObType *myAPMData)
{

    if (!pcrecpp::RE("^APMCCSDSObType").FullMatch(myAPMData->GetTypeName()))
        return false;

    // Re-cast the generic ObType pointer as a CCSDSAPMObtype pointer
    APMCCSDSObType *myAPM = (APMCCSDSObType*)myAPMData;
	...
	myAPM->ccsdsHeader = currentCCSDSHeader;
        myAPM->ccsdsMetaData = (APMCCSDSMetaData*)currentCCSDSMetaData;
...
//
//------------------------------------------------------------------------------
bool APMCCSDSDataFile::GetCCSDSAPMData(std::string &lff,
                                              APMCCSDSObType *myOb)
{
    ...
    {
        if (GetAPMQuaternionCCSDSData(lff,myOb))
        {
            if (commentsFound)
            {
    ...
    if (pcrecpp::RE(regex).FullMatch(lff))
    {
        if(GetAPMEulerAngleCCSDSData(lff,myOb))
        {
            if (commentsFound)
            {
    ...
    if (pcrecpp::RE(regex).FullMatch(lff))
    {
        if(GetAPMSpinStabilizedCCSDSData(lff,myOb))
        {
            if (commentsFound)
            {
    ...
    if (pcrecpp::RE(regex).FullMatch(lff))
    {
        if(GetSpacecraftInertiaCCSDSData(lff,myOb))
        {
            if (commentsFound)
            {
    ...
    {
        if (GetAttitudeManeuverCCSDSData(lff,myOb))
        {
            if (commentsFound)
...
//
//------------------------------------------------------------------------------
bool APMCCSDSDataFile::GetAPMQuaternionCCSDSData(std::string &lff,
                                                    APMCCSDSObType *myOb)
{

    APMQuaternionCCSDSData *myAPMQuaternion = new APMQuaternionCCSDSData;
        ...
        requiredCount < requiredNumberQuaternionParameters || isAQuaternionKeyword))
    {
        ...
        switch (keyID)
        {
            case APMQuaternionCCSDSData::CCSDS_QUATERNION_TIMETAG_ID:
            ...
            case APMQuaternionCCSDSData::CCSDS_QUATERNION_FRAMEA_ID:
            ...
            case APMQuaternionCCSDSData::CCSDS_QUATERNION_FRAMEB_ID:
            ...
            case APMQuaternionCCSDSData::CCSDS_QUATERNION_DIRECTION_ID:
            {
                std::string svalue;
            ...
            case APMQuaternionCCSDSData::CCSDS_QUATERNION_Q1_ID:
            ...
            case APMQuaternionCCSDSData::CCSDS_QUATERNION_Q2_ID:
            ...
            case APMQuaternionCCSDSData::CCSDS_QUATERNION_Q3_ID:
            ...
            case APMQuaternionCCSDSData::CCSDS_QUATERNION_QC_ID:
            ...
            case APMQuaternionCCSDSData::CCSDS_QUATERNION_Q1DOT_ID:
            ...
            case APMQuaternionCCSDSData::CCSDS_QUATERNION_Q2DOT_ID:
            ...
            case APMQuaternionCCSDSData::CCSDS_QUATERNION_Q3DOT_ID:
            ...
            case APMQuaternionCCSDSData::CCSDS_QUATERNION_QCDOT_ID:
            ...
            case APMQuaternionCCSDSData::CCSDS_QUATERNION_XRATE_ID:
            ...
            case APMQuaternionCCSDSData::CCSDS_QUATERNION_YRATE_ID:
            ...
            case APMQuaternionCCSDSData::CCSDS_QUATERNION_ZRATE_ID:
    ...
    {
        MessageInterface::ShowMessage("Error: Quaternion ing did not find all required parameters! %d of %d Abort...\n",requiredCount,requiredNumberQuaternionParameters);
        return false;
    }
...
//
//------------------------------------------------------------------------------
bool APMCCSDSDataFile::GetAPMEulerAngleCCSDSData(std::string &lff,
                                                    APMCCSDSObType *myOb)
{

    APMEulerAngleCCSDSData *myAPMEulerAngle = new APMEulerAngleCCSDSData;
        ...
        requiredCount < requiredNumberEulerAngleParameters || isAnEulerKeyword))
    {
        ...
        switch (keyID)
        {
            ...
            case EulerAngleCCSDSData::CCSDS_EULERANGLE_FRAMEA_ID:
            ...
            case EulerAngleCCSDSData::CCSDS_EULERANGLE_FRAMEB_ID:
            ...
            case EulerAngleCCSDSData::CCSDS_EULERANGLE_DIRECTION_ID:
            {
                std::string svalue;
                if (!GetCCSDSValue(lff,svalue))
                    return false;
            ...
            case EulerAngleCCSDSData::CCSDS_EULERANGLE_ROTATIONSEQUENCE_ID:
            {
                std::string stemp;
            ...
            case EulerAngleCCSDSData::CCSDS_EULERANGLE_XANGLE_ID:
                // Fall through
            case EulerAngleCCSDSData::CCSDS_EULERANGLE_YANGLE_ID:
                // Fall through
            case EulerAngleCCSDSData::CCSDS_EULERANGLE_ZANGLE_ID:
            ...
            case EulerAngleCCSDSData::CCSDS_EULERANGLE_RATEFRAME_ID:
            {
            ...
            case EulerAngleCCSDSData::CCSDS_EULERANGLE_XRATE_ID:
                // Fall through
            case EulerAngleCCSDSData::CCSDS_EULERANGLE_YRATE_ID:
                // Fall through
            case EulerAngleCCSDSData::CCSDS_EULERANGLE_ZRATE_ID:
    ...
    {
        MessageInterface::ShowMessage("Error: Euler Angle ing did not find all required parameters! %d of %d Abort...\n",requiredCount,requiredNumberEulerAngleParameters);
        return false;
    }
...
//
//------------------------------------------------------------------------------
bool APMCCSDSDataFile::GetAPMSpinStabilizedCCSDSData(std::string &lff,
                                                        APMCCSDSObType *myOb)
{

    APMSpinStabilizedCCSDSData *myAPMSpinStabilized = new APMSpinStabilizedCCSDSData;
        ...
        requiredCount < requiredNumberSpinStabilizedParameters || isASpinStabilizedKeyword))
    {
        ...
        switch (keyID)
        {
            ...
            case APMSpinStabilizedCCSDSData::CCSDS_SPINSTABILIZED_FRAMEA_ID:
            ...
            case APMSpinStabilizedCCSDSData::CCSDS_SPINSTABILIZED_FRAMEB_ID:
            ...
            case APMSpinStabilizedCCSDSData::CCSDS_SPINSTABILIZED_DIRECTION_ID:
            {
                std::string svalue;
                if (!GetCCSDSValue(lff,svalue))
                    return false;
            ...
            case APMSpinStabilizedCCSDSData::CCSDS_SPINSTABILIZED_SPINALPHA_ID:
            ...
            case APMSpinStabilizedCCSDSData::CCSDS_SPINSTABILIZED_SPINDELTA_ID:
            ...
            case APMSpinStabilizedCCSDSData::CCSDS_SPINSTABILIZED_SPINANGLE_ID:
            ...
            case APMSpinStabilizedCCSDSData::CCSDS_SPINSTABILIZED_SPINANGLEVEOCITY_ID:
            ...
            case APMSpinStabilizedCCSDSData::CCSDS_SPINSTABILIZED_NUTATION_ID:
            ...
            case APMSpinStabilizedCCSDSData::CCSDS_SPINSTABILIZED_NUTATIONPERIOD_ID:
            ...
            case APMSpinStabilizedCCSDSData::CCSDS_SPINSTABILIZED_NUTATIONPHASE_ID:
    ...
    {
        MessageInterface::ShowMessage("Error: Spin Stabilized ing did not find all required parameters! %d of %d Abort...\n",requiredCount,requiredNumberSpinStabilizedParameters);
        return false;
    }
...
//
//------------------------------------------------------------------------------
bool APMCCSDSDataFile::GetSpacecraftInertiaCCSDSData(std::string &lff,
                                                           APMCCSDSObType *myOb)
{

    SpacecraftInertiaCCSDSData *myAPMSpacecraftInertia = new SpacecraftInertiaCCSDSData;
    ...
    do
    {
        ...
        switch (keyID)
        {
            ...
            case SpacecraftInertiaCCSDSData::CCSDS_SPACECRAFTINERTIA_INERTIAREFFRAME_ID:
            ...
            case SpacecraftInertiaCCSDSData::CCSDS_SPACECRAFTINERTIA_I11_ID:
            ...
            case SpacecraftInertiaCCSDSData::CCSDS_SPACECRAFTINERTIA_I22_ID:
            ...
            case SpacecraftInertiaCCSDSData::CCSDS_SPACECRAFTINERTIA_I33_ID:
            ...
            case SpacecraftInertiaCCSDSData::CCSDS_SPACECRAFTINERTIA_I12_ID:
            ...
            case SpacecraftInertiaCCSDSData::CCSDS_SPACECRAFTINERTIA_I13_ID:
            ...
            case SpacecraftInertiaCCSDSData::CCSDS_SPACECRAFTINERTIA_I23_ID:
    ...
    {
        MessageInterface::ShowMessage("Error: Spacecraft Intertia ing did not find all required parameters! %d of %d Abort...\n",requiredCount,requiredNumberSpacecraftInertiaParameters);
        return false;
    }
...
//
//------------------------------------------------------------------------------
bool APMCCSDSDataFile::GetAttitudeManeuverCCSDSData(std::string &lff,
                                                          APMCCSDSObType *myOb)
{

    AttitudeManeuverCCSDSData *myAPMManeuver = new AttitudeManeuverCCSDSData;
    ...
    do
    {
        ...
        switch (keyID)
        {
            ...
            case AttitudeManeuverCCSDSData::CCSDS_ATTITUDEMANUEVER_EPOCHSTART_ID:
            ...
            case AttitudeManeuverCCSDSData::CCSDS_ATTITUDEMANUEVER_DURATION_ID:
            ...
            case AttitudeManeuverCCSDSData::CCSDS_ATTITUDEMANUEVER_REFFRAME_ID:
            ...
            case AttitudeManeuverCCSDSData::CCSDS_ATTITUDEMANUEVER_TOR1_ID:
            ...
            case AttitudeManeuverCCSDSData::CCSDS_ATTITUDEMANUEVER_TOR2_ID:
            ...
            case AttitudeManeuverCCSDSData::CCSDS_ATTITUDEMANUEVER_TOR3_ID:
    ...
    {
        MessageInterface::ShowMessage("Error: Attitude Maneuver ing did not find all required parameters! %d of %d Abort...\n",requiredCount,requiredNumberAttitudeManeuverParameters);
        return false;
    }
...
//------------------------------------------------------------------------------
// bool GetCCSDSMetaData(std::string &lff, APMCCSDSObType *myOb)
//------------------------------------------------------------------------------
/**
...
//
//------------------------------------------------------------------------------
bool APMCCSDSDataFile::GetCCSDSMetaData(std::string &lff,
                                APMCCSDSObType *myOb)
{
    APMCCSDSMetaData *myMetaData = new APMCCSDSMetaData;
    ...
    do
    {
        ...
        switch (keyID)
        {
            ...
            case APMCCSDSMetaData::CCSDS_APM_METADATACOMMENTS_ID:
            {
                std::string stemp;
