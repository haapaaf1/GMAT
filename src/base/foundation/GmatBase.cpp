...
const Real SI_PREFIXES_FACTOR[Gmat::UNKNOWN_SI_PREFIX+1] =
{
  1e24,     1e21,   1e18,   1e15,   1e12,   1e9,    1e6,    1000,
  100,      10,     0.1,    0.01,   0.001,  1e-6,   1e-9,   1e-12,
  1e-15,    1e-18,  1e-21,  1e-24,  1
};

const std::string
GmatBase::SI_PREFIXES_SYMBOL[Gmat::UNKNOWN_SI_PREFIX+1] =
{
    "Y",    "Z",        "E",    "P",    "T",    "G",
    "M",    "k",        "h",    "da",   "d",    "c",
    "m",    "mu",       "n",    "p",    "f",    "a",
...
const std::string
GmatBase::SI_PREFIXES_STRING[Gmat::UNKNOWN_SI_PREFIX+1] =
{
...
const std::string
GmatBase::ANGLE_UNITS_SYMBOL[Gmat::UNKNOWN_ANGLE_UNIT+1] =
{
    "rad", "sr", "deg", ""
};

const std::string
GmatBase::ANGLE_UNITS_STRING[Gmat::UNKNOWN_ANGLE_UNIT+1] =
{
    "Radians", "Steradians", "Degrees", ""
};

const std::string
GmatBase::AREA_UNITS_SYMBOL[Gmat::UNKNOWN_AREA_UNIT+1] =
{
...
const std::string
GmatBase::AREA_UNITS_STRING[Gmat::UNKNOWN_AREA_UNIT+1] =
{
...
const std::string
GmatBase::DISTANCE_UNITS_SYMBOL[Gmat::UNKNOWN_DISTANCE_UNIT+1] =
{
   "m",     "league",   "mi",       "naut mi",
   "fur",   "rd",       "fath",     "yd",
   "ft",    "in",       "ua",       "ly",
...
const std::string
GmatBase::DISTANCE_UNITS_STRING[Gmat::UNKNOWN_DISTANCE_UNIT+1] =
{
...
const std::string
GmatBase::ELECTRIC_UNITS_SYMBOL[Gmat::UNKNOWN_ELECTRIC_UNIT+1] =
{
    "A", "Ah", "C", "F", "S", "H", "V", "Omega", ""
};

const std::string
GmatBase::ELECTRIC_UNITS_STRING[Gmat::UNKNOWN_ELECTRIC_UNIT+1] =
{
...
const std::string
GmatBase::ENERGY_UNITS_SYMBOL[Gmat::UNKNOWN_ENERGY_UNIT+1] =
{
...
const std::string
GmatBase::ENERGY_UNITS_STRING[Gmat::UNKNOWN_ENERGY_UNIT+1] =
{
...
const std::string
GmatBase::FORCE_UNITS_SYMBOL[Gmat::UNKNOWN_FORCE_UNIT+1] =
{
...
const std::string
GmatBase::FORCE_UNITS_STRING[Gmat::UNKNOWN_FORCE_UNIT+1] =
{
...
const std::string
GmatBase::LUMINANCE_UNITS_SYMBOL[Gmat::UNKNOWN_LUMINANCE_UNIT+1] =
{
    "L", "fL", "cd/m^2", "nit", ""
};

const std::string
GmatBase::LUMINANCE_UNITS_STRING[Gmat::UNKNOWN_LUMINANCE_UNIT+1] =
{
...
const std::string
GmatBase::ILLUMINANCE_UNITS_SYMBOL[Gmat::UNKNOWN_ILLUMINANCE_UNIT+1] =
{
    "fc", "lx", "ph", ""
};

const std::string
GmatBase::ILLUMINANCE_UNITS_STRING[Gmat::UNKNOWN_ILLUMINANCE_UNIT+1] =
{
    "Foot Candle", "Lux", "Phot", "UnknownIlluminanceUnit"
};

const std::string
GmatBase::LUMINOUS_FLUX_UNITS_SYMBOL[Gmat::UNKNOWN_LUMINOUSFLUX_UNIT+1] =
{
    "lm", "R", ""
};

const std::string
GmatBase::LUMINOUS_FLUX_UNITS_STRING[Gmat::UNKNOWN_LUMINOUSFLUX_UNIT+1] =
{
    "Lumen", "Rayleigh", "UnknownLuminousFluxUnit"
};

const std::string
GmatBase::LUMINOUS_ENERGY_UNITS_SYMBOL[Gmat::UNKNOWN_LUMINOUSENERGY_UNIT+1] =
{
       "T", ""
};

const std::string
GmatBase::LUMINOUS_ENERGY_UNITS_STRING[Gmat::UNKNOWN_LUMINOUSENERGY_UNIT+1] =
{
       "Talbot", "UnknownLuminousEnergyUnit"
};

const std::string
GmatBase::LUMINOUS_INTENSITY_UNITS_SYMBOL[Gmat::UNKNOWN_LUMINOUSINTENSITY_UNIT+1] =
{
    "cd", "cp", ""
};

const std::string
GmatBase::LUMINOUS_INTENSITY_UNITS_STRING[Gmat::UNKNOWN_LUMINOUSINTENSITY_UNIT+1] =
{
       "Candela", "Candle Power", "UnknownLuminousIntensityUnit"
};

const std::string
GmatBase::MASS_UNITS_SYMBOL[Gmat::UNKNOWN_MASS_UNIT+1] =
{
...
const std::string
GmatBase::MASS_UNITS_STRING[Gmat::UNKNOWN_MASS_UNIT+1] =
{
...
const std::string
GmatBase::PRESSURE_UNITS_SYMBOL[Gmat::UNKNOWN_PRESSURE_UNIT+1] =
{
    "psi",  "atm",  "torr", "bar",  "Pa",   "UnknownPressureUnit"
};

const std::string
GmatBase::PRESSURE_UNITS_STRING[Gmat::UNKNOWN_PRESSURE_UNIT+1] =
{
...
/*
const std::string
GmatBase::RADIANCE_UNITS_SYMBOL[Gmat::UNKNOWN_RADIANCE_UNIT+1] =
{
    "J",  "W",  "W/sr", "W/sr m^2",  "",   "UnknownPressureUnit"
};

const std::string
GmatBase::RADIANCE_UNITS_STRING[Gmat::UNKNOWN_RADIANCE_UNIT+1] =
{
    "Pounds per square inch",  "Atmospheres",  "Torr", "Bar",
    "Pascals",   "UnknownPressureUnit"
};
*/
const std::string
GmatBase::TEMPERATURE_UNITS_SYMBOL[Gmat::UNKNOWN_TEMPERATURE_UNIT+1] =
{
    "F",    "C",    "Kelvin",   "Rankine",  "UnknownTemperatureUnit"
};

const std::string
GmatBase::TEMPERATURE_UNITS_STRING[Gmat::UNKNOWN_TEMPERATURE_UNIT+1] =
{
    "Fahrenheit", "Celsius", "Kelvin",   "Rankine",  "UnknownTemperatureUnit"
};

const std::string
GmatBase::VOLUME_UNITS_SYMBOL[Gmat::UNKNOWN_VOLUME_UNIT+1] =
{
...
const std::string
GmatBase::VOLUME_UNITS_STRING[Gmat::UNKNOWN_VOLUME_UNIT+1] =
{
...
const std::string
GmatBase::TIME_UNITS_SYMBOL[Gmat::UNKNOWN_TIME_UNIT+1] =
{
...
const std::string
GmatBase::TIME_UNITS_STRING[Gmat::UNKNOWN_TIME_UNIT+1] =
{
...
const std::string
GmatBase::MILITARY_TIME_ZONE_CODES[Gmat::EndMilitaryTimeZones+1] =
{
...
const Real
GmatBase::MILITARY_TIME_UTC_OFFSETS[Gmat::EndMilitaryTimeZones+1] =
{
...
const std::string
GmatBase::US_TIME_ZONE_CODES[Gmat::EndUSTimeZones+1] =
{
...
const Real
GmatBase::US_TIME_UTC_OFFSETS[Gmat::EndUSTimeZones+1] =
{
...
const std::string
GmatBase::CANADA_TIME_ZONE_CODES[Gmat::EndCanadaTimeZones+1] =
{
...
const Real
GmatBase::CANADA_TIME_UTC_OFFSETS[Gmat::EndCanadaTimeZones+1] =
{
