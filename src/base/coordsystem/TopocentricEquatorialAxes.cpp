...
#include "TopocentricEquatorialAxes.hpp"
...
//const std::string
//TopocentricEquatorialAxes::PARAMETER_TEXT[TopocentricEquatorialAxesParamCount - DynamicAxesParamCount] =
//{
//};
//
//const Gmat::ParameterType
//TopocentricEquatorialAxes::PARAMETER_TYPE[TopocentricEquatorialAxesParamCount - DynamicAxesParamCount] =
//{
//};
...
//------------------------------------------------------------------------------
/**
 * Constructs base TopocentricEquatorialAxes structures
 * (default constructor).
 *
 * @param itsName Optional name for the object.  Defaults to "".
 */
//------------------------------------------------------------------------------
TopocentricEquatorialAxes::TopocentricEquatorialAxes(const std::string &itsName) :
DynamicAxes("BodyFixed",itsName),
de(NULL)
{
   objectTypeNames.push_back("TopocentricEquatorialAxes");
   parameterCount = TopocentricEquatorialAxesParamCount;
}
...
//------------------------------------------------------------------------------
/**
 * Constructs base TopocentricEquatorialAxes structures used in derived classes, by copying 
 * the input instance (copy constructor).
 *
 * @param teaxes  TopocentricEquatorialAxes instance to copy to create "this" instance.
 */
//------------------------------------------------------------------------------
TopocentricEquatorialAxes::TopocentricEquatorialAxes(const TopocentricEquatorialAxes &teaxes) :
DynamicAxes    (teaxes),
de             (NULL)
{
}
...
//------------------------------------------------------------------------------
//  TopocentricEquatorialAxes& operator=(const TopocentricEquatorialAxes &teaxes)
//------------------------------------------------------------------------------
/**
 * Assignment operator for TopocentricEquatorialAxes structures.
 *
 * @param teaxes The original that is being copied.
 *
 * @return Reference to this object
 */
//------------------------------------------------------------------------------
const TopocentricEquatorialAxes& TopocentricEquatorialAxes::operator=(const TopocentricEquatorialAxes &teaxes)
{
   if (&teaxes == this)
      return *this;
   DynamicAxes::operator=(teaxes); 
   de = teaxes.de; 
   return *this;
}
...
//------------------------------------------------------------------------------
//  ~TopocentricEquatorialAxes(void)
//------------------------------------------------------------------------------
/**
 * Destructor.
 */
//------------------------------------------------------------------------------
TopocentricEquatorialAxes::~TopocentricEquatorialAxes()
{
}

GmatCoordinate::ParameterUsage TopocentricEquatorialAxes::UsesEopFile() const
{
   return GmatCoordinate::REQUIRED;
}

GmatCoordinate::ParameterUsage TopocentricEquatorialAxes::UsesItrfFile() const
{
   return GmatCoordinate::REQUIRED;
}

GmatCoordinate::ParameterUsage TopocentricEquatorialAxes::UsesNutationUpdateInterval() const
{
...
//------------------------------------------------------------------------------
/**
 * Initialization method for this TopocentricEquatorialAxes.
 *
 */
//------------------------------------------------------------------------------
bool TopocentricEquatorialAxes::Initialize()
{
 ...
 */
//------------------------------------------------------------------------------
GmatBase* TopocentricEquatorialAxes::Clone() const
{
   return (new TopocentricEquatorialAxes(*this));
}
 ...
 */
//------------------------------------------------------------------------------
//std::string TopocentricEquatorialAxes::GetParameterText(const Integer id) const
//{
//   if (id >= DynamicAxesParamCount && id < TopocentricEquatorialAxesParamCount)
 ...
 */
//------------------------------------------------------------------------------
//Integer TopocentricEquatorialAxes::GetParameterID(const std::string &str) const
//{
//   for (Integer i = DynamicAxesParamCount; i < TopocentricEquatorialAxesParamCount; i++)
//   {
 ...
 */
//------------------------------------------------------------------------------
//Gmat::ParameterType TopocentricEquatorialAxes::GetParameterType(const Integer id) const
//{
//   if (id >= DynamicAxesParamCount && id < TopocentricEquatorialAxesParamCount)
 ...
 */
//------------------------------------------------------------------------------
//std::string TopocentricEquatorialAxes::GetParameterTypeString(const Integer id) const
//{
 ...
 */
//------------------------------------------------------------------------------
//std::string TopocentricEquatorialAxes::GetStringParameter(const Integer id) const
//{
 ...
 */
//------------------------------------------------------------------------------
//bool TopocentricEquatorialAxes::SetStringParameter(const Integer id, 
 ...
 */
//------------------------------------------------------------------------------
//std::string TopocentricEquatorialAxes::GetStringParameter(const std::string &label) const
//{
 ...
 */
//------------------------------------------------------------------------------
//bool TopocentricEquatorialAxes::SetStringParameter(const std::string &label,
//                                        const std::string &value)
//{
 ...
 */
//------------------------------------------------------------------------------
void TopocentricEquatorialAxes::CalculateRotationMatrix(const A1Mjd &atEpoch,
