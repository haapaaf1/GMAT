...
public:
    ...
    bool ProcessTLEData(std::string &lff, std::string &lff2, 
			       tle_obtype &myTLEdata);
    bool ProcessB3Data(std::string &lff, b3_obtype &myB3data);
...
private:
    ...
    static const Integer NUM_DATA_TYPES = 3;
    static const std::string DATA_TYPE_DESCRIPTIONS[NUM_DATA_TYPES];
