...
#include "Msise00Atmosphere.hpp"
#include "MessageInterface.hpp"
#include "CelestialBody.hpp"

#ifndef __SKIP_Msise00__
extern "C" 
{ 
   void gtd7_(int*,float*,float*,float*,float*,float*,float*,float*,float*,int*,float*,float*);
}
#endif

//#define DEBUG_Msise00_ATMOSPHERE

#ifdef DEBUG_Msise00_ATMOSPHERE
 ...
 */
//------------------------------------------------------------------------------
Msise00Atmosphere::Msise00Atmosphere() :
    AtmosphereModel     ("Msise00"),
    fileData            (false),
    fluxfilename        ("")
{
    #ifdef DEBUG_Msise00_ATMOSPHERE
 ...
 *  Copy constructor.
 *
 * @param <msise> Msise00 object to copy increating the new one.
 */
//------------------------------------------------------------------------------
Msise00Atmosphere::Msise00Atmosphere(const Msise00Atmosphere& msise) :
...
//------------------------------------------------------------------------------
//  Msise00Atmosphere& operator= (const Msise00Atmosphere& m)
//------------------------------------------------------------------------------
/**
 * Assignment operator for the Msise00Atmosphere class.
 *
 * @param <m> the Msise00Atmosphere object whose data to assign to "this"
 *            AtmosphereModel.
 *
 * @return "this" Msise00Atmosphere with data of input Msise00Atmosphere st.
 */
//------------------------------------------------------------------------------
Msise00Atmosphere& Msise00Atmosphere::operator=(const Msise00Atmosphere& msise)
{
   if (&msise == this)
      return *this;
 ...
 */
//------------------------------------------------------------------------------
bool Msise00Atmosphere::Density(Real *pos, Real *density, Real epoch, 
                                Integer count)
{
   Integer i, i6;
   Real    alt;
   ...
   #ifdef DEBUG_Msise00_ATMOSPHERE
   logFile = fopen("GMAT-Msise00.txt", "w");
   #endif
   
   if (mCentralBody == NULL)
      throw AtmosphereException(
         "Central body pointer not set in Msise00 model.");
   ...
   for (i = 0; i < count; ++i) 
   {
      ...
      #ifdef DEBUG_Msise00_ATMOSPHERE
         MessageInterface::ShowMessage(
            "Calculating Msise00 Density from parameters:\n   "
            "yd = %d\n   sod = %lf   alt = %lf\n   lat = %lf\n   lon = %lf\n"
            "   lst = %lf\n   f107a = %lf\n   f107 = %lf\n   ap = "
...
#ifndef __SKIP_Msise00__
      gtd7_(&xyd,&xsod,&xalt,&xlat,&xlon,&xlst,&xf107a,&xf107,&xap[0],&xmass,&xden[0],&xtemp[0]);
#endif
      
      #ifdef DEBUG_Msise00_ATMOSPHERE
      fprintf(logFile, "Post-GTDS7() \n");
      fprintf(logFile, "=========== \n");
      fprintf(logFile, "Epoch                  = %le \n", epoch);
      fprintf(logFile, "Year & Days            = %d \n", xyd);
      fprintf(logFile, "Seconds                = %le \n", xsod);
 ...
 */
//------------------------------------------------------------------------------
void Msise00Atmosphere::GetInputs(Real epoch)
{
    /// @todo Get the Msise00 epoch wired up; this is a crude approximation
 ...
 */
//------------------------------------------------------------------------------
GmatBase* Msise00Atmosphere::Clone() const
{
   return (new Msise00Atmosphere(*this));
}
