...
public:
  ...
  Rvector3 GetUnitVector(const Real &er, const Real &flattening);
  ...
  Rvector3 GetSitePosition(const Real &equatorialRadius, 
...
protected:
  ...
  // protected methods
  void CartesianToLatLonHgt( const Rvector3 &cartVector, 
			     const Real &equatorialRadius, 
			     const Real &flattening, 
			     const std::string &typ="Geodetic",
			     const std::string &hgtReference="Ellipsoid");
  void SatCartesianToLatLonHgt( const Rvector3 &cartVector, 
			        const Real &equatorialRadius, 
			        const Real &flattening, 
			        const std::string &typ="Geodetic",
			        const std::string &hgtReference="Ellipsoid");
