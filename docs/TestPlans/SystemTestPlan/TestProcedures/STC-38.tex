...
\centering
      ...
      \hline
         \rowcolor[rgb]{0.8,0.8,0.8} Name & STC-38 Spacecraft GUI Coordinate System Conversion Tests\\
         \hline
         ...
         \begin{compactenum}
         \item Open the dialog box for SatCS\_SSBary via the GUI.
         \item Enter the CS\_SSBary state data  defined in TD-3.
         ...
         %------- The test data is here
         \begin{compactenum}
         \item Perform the test again using  EarthMJ2000Ec, EarthFixed, LunaFixed, CS\_ESL2,  EarthMoonRot, SunMJ2000Ec, and PhobosMJ2000Eq in step 4.
         \end{compactenum}\\
         %------- The test data is here
         \hline
...
\end{tabular}
      \label{Table:STC-38}
      \caption{STC-38 Spacecraft GUI Coordinate System Conversion Tests}
       \index{Test Data!STC-38}
\end{table} 