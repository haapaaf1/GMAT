...
\centering
      ...
      \hline
         \rowcolor[rgb]{0.8,0.8,0.8} Name & STC-35 Spacecraft GUI Coordinate System Conversion Tests\\
         \hline
         ...
         \begin{compactenum}
         \item Open the dialog box for SatEarthMoonRot via the GUI.
         \item Enter the EarthMoonRot state data  defined in TD-3.
         ...
         %------- The test data is here
         \begin{compactenum}
         \item Perform the test again using EarthMJ2000Ec, EarthFixed, LunaFixed, CS\_ESL2, CS\_SSBary,  SunMJ2000Ec, and PhobosMJ2000Eq  in step 4.
         \end{compactenum}\\
         %------- The test data is here
         \hline
...
\end{tabular}
      \label{Table:STC-35}
      \caption{STC-35 Spacecraft GUI Coordinate System Conversion Tests}
       \index{Test Data!STC-35}
\end{table}
