...
\centering
      ...
      \hline
         \rowcolor[rgb]{0.8,0.8,0.8} Name & STC-29 Spacecraft GUI TTGregorian to Other Epoch Types\\
         \hline
         ...
         \item Change the Epoch Format to TTGregorian.
         \item Enter the TTGregorian epoch defined in Table \ref{Table:TD-2}.
         ...
         %------- The test data is here
         \begin{compactenum}
         \item Perform the test using UTCModJulian, TAIGregorian, TAIModJulian, TTModJulian, A1ModJulian,
...
\end{tabular}
      \label{Table:STC-29}
      \caption{STC-29 Spacecraft GUI TTGregorian to Other Epoch Types}
       \index{Test Data!STC-29}
\end{table} 