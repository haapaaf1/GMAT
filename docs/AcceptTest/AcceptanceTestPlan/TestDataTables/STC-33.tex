...
\centering
      ...
      \hline
         \rowcolor[rgb]{0.8,0.8,0.8} Name & STC-33 Spacecraft GUI Coordinate System Conversion Tests\\
         \hline
         ...
         \begin{compactenum}
         \item Open the dialog box for SatEarthFixed via the GUI.
         \item Enter the EarthFixed state data  defined in TD-3.
         ...
         %------- The test data is here
         \begin{compactenum}
         \item Perform the test again using  EarthMJ2000Ec,  LunaFixed, CS\_ESL2, CS\_SSBary, EarthMoonRot, SunMJ2000Ec, and PhobosMJ2000Eq in step 4.
         \end{compactenum}\\
         %------- The test data is here
         \hline
...
\end{tabular}
      \label{Table:STC-33}
      \caption{STC-33 Spacecraft GUI Coordinate System Conversion Tests}
       \index{Test Data!STC-33}
\end{table} 