...
% Used MATLAB script that was last modified 10-Aug-2005 by EDove
...
%GMAT EarthEGM96.Gravity.Earth.Model = ./files/gravity/earth/EGM96.grv;
GMAT EarthEGM96.Gravity.Earth.Model = EGM96.grv;
...
GMAT GEO_Report.Filename =  APT_GMAT_GEO_EarthSunLuna_EGM96_JR_SRP.report;
