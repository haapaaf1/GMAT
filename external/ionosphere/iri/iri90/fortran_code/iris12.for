C IRIS12.FOR, Version 12.2.7 ---------------------- September 1994
C
C*****************************************************************
...
C---- everything up to here inlcuded on diskette -----------------
...
C  OTHER TWO TO ZERO.
C
C  OUTPUT:  OUTF(1:10,1:50)   IRI PROFILES FROM HEIGHT HEIBEG TO
C			      HEIEND IN STEPS OF HEISTP.
...
C OARR(31) = ISEASON (1=spring) OARR(32) = NSEASON (1=northern spring)
C-------------------------------------------------------------------
C*****************************************************************
...
C!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
C1344    OPEN(IUCCIR,FILE=FILNAM,STATUS='OLD',ERR=8448,
C     &		FORM='FORMATTED')
