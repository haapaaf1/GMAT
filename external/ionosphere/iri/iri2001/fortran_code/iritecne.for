c iritecne.for, version number can be found at the end of this comment.
c-----------------------------------------------------------------------        
C
C contains IRIT13NE, IONCORR, IRI_TEC subroutines to computed the 
...
C
C
        subroutine IRIT13NE(ALATI,ALONG,jmag,jf,iy,md,hour,hbeg,hend,
     &                          tec,tecb,tect)
c-----------------------------------------------------------------------        
...
c
        ...
        aend=hend
        astp=hend-hbeg
        call IRI_SUB_NE(JF,JMAG,ALATI,ALONG,IY,MD,HOUR,
