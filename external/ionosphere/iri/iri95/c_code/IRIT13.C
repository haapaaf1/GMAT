/* irit13.f -- translated by f2c (version 19990311).
...
/* IRIT13.FOR ------------------------------------ Oct 20, 1995 */

/* contains IRIT13, IONCORR, IRI_TEC */
...
{
    static real aend, oarr[35], astp, outf[1100]	/* was [11][100] */;
    extern /* Subroutine */ int iris13_(logical *, integer *, real *, real *, 
	    integer *, integer *, real *, real *, real *, real *, real *, 
	    real *), iri_tec__(real *, real *, integer *, real *, real *, 
	    real *);
    static real abeg;
...
/*          jf(1:20)     =.true./.false. flags; explained in IRIS13.FOR */
...
/* initialize IRI parameter in COMMON blocks */
    ...
    aend = *hend;
    astp = *hend - *hbeg;
    iris13_(&jf[1], jmag, alati, along, iy, md, hour, &abeg, &aend, &astp, 
	    outf, oarr);
...
/* test   call iri_tec (hbeg,hend,0,tec,tect,tecb) */

/*  to get ionospheric correction for frequency f/Hz use the following */
/*  formula   ioncorr/m = 40.3 * TEC / (f*f) */
	...
	*tectot, real *tectop, real *tecbot)
{
    ...
    static integer ia;
    static real hh, hr[6], hu;
    extern doublereal xe_(real *);
    static real hx, sumbot, x_2__, x_3__, x_4__, x_5__, sumtop, del_hei__, 
	    hei_end__, yne, hss, xkk, hei_top__, top_end__, ed_2__, ed_3__, 
	    ed_4__, ed_5__, yyy, zzz, ss_2__, ss_3__, ss_4__;
...
/*               =2 [stepsize of 1km throughout; best TEC, but needs time] */
/*   OUTPUT: */
/*       tectot  total ionospheric content in tec-units (10^16 m^-2) */
/*       tectop  topside content (in %) */
/*       tecbot  bottomside content (in %) */

/*   The different stepsizes for the numerical integration are defined as */
/*   follows (h1=100km, h2=hmF2-10km, h3=hmF2+10km, h4=hmF2+150km, h5= */
/*   hmF2+250km): */
...
L5:
    ...
    xntop = xe_(&hei_end__) / block1_1.xnmf2;
    if (xntop > (float).9999) {
	ss_t__ = top_end__;
	goto L2345;
    }
...
/*       hss = 360. */
    ...
    x_4__ = hei_top__ - hss * log(xkk * (hei_4__ - hei_top__) / top_end__ + (
	    float)1.);
    x_5__ = hei_end__;
    ed_2__ = xe_(&x_2__) / block1_1.xnmf2;
    if (ed_2__ > (float)1.) {
	ed_2__ = (float)1.;
    }
    ed_3__ = xe_(&x_3__) / block1_1.xnmf2;
    if (ed_3__ > (float)1.) {
	ed_3__ = (float)1.;
    }
    ed_4__ = xe_(&x_4__) / block1_1.xnmf2;
    if (ed_4__ > (float)1.) {
	ed_4__ = (float)1.;
    }
    ed_5__ = xntop;
