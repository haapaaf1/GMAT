...
C
C  METHOD
C     The user is asked for the root name of an unformatted MLF PIM database
C     file and the root name of the formatted MLF PIM database files to be
...
C
C  FILES ACCESSED
C     Unit 1   Unformatted MLF PIM database files
C     Unit 2   Formatted MLF PIM database files
C
C  AUTHOR
C     Lincoln Brown
...
C
      ...
      WRITE(2,200) (REC(I),I=1,1)
      DO 300 J=1,8*24*12
         READ(1,REC=7+J) (REC(I),I=1,9)
         WRITE(2,200) (REC(I),I=1,9)
  300 CONTINUE
C
