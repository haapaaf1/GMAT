...
#ifndef _CCSDSDATAFILE_HPP
#define	_CCSDSDATAFILE_HPP

#include "DataFile.hpp"

class CCSDSDataFile : public DataFile
{

public:
    
    CCSDSDataFile(const std::string &itsType, const std::string &itsName);
    CCSDSDataFile(const CCSDSDataFile &CCSDSdf);
    const CCSDSDataFile& operator=(const CCSDSDataFile &CCSDSdf);
    virtual ~CCSDSDataFile();
