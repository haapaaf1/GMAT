...
class TDMCCSDSMetaData : public CCSDSMetaData
{
...
protected:
    ...
    static const std::string CCSDS_TDM_METADATA_KEYWORDS[EndTDMCCSDSMetaDataReps];
    static const std::string CCSDS_METADATA_FILEFORMAT_DESCRIPTIONS[EndTDMCCSDSMetaDataReps];
    static const std::string CCSDS_METADATA_UNIT_DESCRIPTIONS[EndTDMCCSDSMetaDataReps];
    static const bool CCSDS_METADATA_IS_REQUIRED[EndTDMCCSDSMetaDataReps];
    static const Gmat::ParameterType CCSDS_METADATA_PARAMETER_TYPE[EndTDMCCSDSMetaDataReps];
