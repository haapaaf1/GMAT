 ...
 */
//---------------------------------------------------------------------------
bool ObType::SetDataParameter(const Integer id, const Real &value)
{
    return false;
}
 ...
 */
//------------------------------------------------------------------------------
bool ObType::SetDataParameter(const std::string &label, const Real &value)
{
 ...
 */
//---------------------------------------------------------------------------
bool ObType::SetDataParameter(const Integer id, const Integer &value)
{
    return false;
}
 ...
 */
//------------------------------------------------------------------------------
bool ObType::SetDataParameter(const std::string &label, const Integer &value)
{
    return SetDataParameter(GetDataParameterID(label),value);
}

//------------------------------------------------------------------------------
// bool SetDataParameter(const Integer id, const IntegerArray &value)
//------------------------------------------------------------------------------
/**
 * Method to set the value of a Integer parameter.
 *
 ...
 */
//---------------------------------------------------------------------------
bool ObType::SetDataParameter(const Integer id, const IntegerArray &value)
{
    return false;
}

//------------------------------------------------------------------------------
// bool SetDataParameter(const std::string &label, const IntegerArray &value) const
//------------------------------------------------------------------------------
/**
 * Method to set the value of a Integer parameter.
 *
 ...
 */
//------------------------------------------------------------------------------
bool ObType::SetDataParameter(const std::string &label, const IntegerArray &value)
{
    return SetDataParameter(GetDataParameterID(label),value);
}
 ...
 */
//---------------------------------------------------------------------------
bool ObType::SetDataParameter(const Integer id, const bool &value)
{
    return false;
}
 ...
 */
//------------------------------------------------------------------------------
bool ObType::SetDataParameter(const std::string &label, const bool &value)
{
    return SetDataParameter(GetDataParameterID(label),value);
}
 ...
 */
//------------------------------------------------------------------------------
bool ObType::SetDataParameter(const Integer id, const std::string &value)
{
    return false;
}
 ...
 */
//------------------------------------------------------------------------------
bool ObType::SetDataParameter(const std::string &label, const std::string &value)
{
    return SetDataParameter(GetDataParameterID(label),value);
}
 ...
 */
//------------------------------------------------------------------------------
bool ObType::SetDataParameter(const Integer id, const StringArray &value)
{
    return false;
}
 ...
 */
//------------------------------------------------------------------------------
bool ObType::SetDataParameter(const std::string &label, const StringArray &value)
{
    return SetDataParameter(GetDataParameterID(label),value);
}
