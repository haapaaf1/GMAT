% REVISION HISTORY
% $Id: If11.m,v 1.2 2007/07/26 19:13:11 edove Exp $
...
Create ReportFile If11;
GMAT If11.Filename = ./output/SystemTest/If11.report;
GMAT If11.Precision = 15;
...
BeginScript;
    ...
    EndIf;
    Report      If11 type ansFlag SC1.A1ModJulian SC1.ElapsedSecs SC1.TA SC1.X SC1.Y SC1.Z;
    GMAT If11.WriteHeaders = Off;
