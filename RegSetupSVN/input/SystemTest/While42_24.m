% REVISION HISTORY
% $Id: While42_24.m,v 1.2 2007/07/26 19:13:12 edove Exp $
...
Create ReportFile While42_24;
GMAT While42_24.Filename = ./output/SystemTest/While42_24.report;
GMAT While42_24.Precision = 15;
...
BeginScript;
   ...
   While SC1.TA == testVar
       ...
       Report      While42_24 type ansFlag ranOK SC1.A1ModJulian SC1.ElapsedSecs SC1.TA SC1.X SC1.Y SC1.Z;
       GMAT While42_24.WriteHeaders = Off;
   EndWhile;   
    Report      While42_24 type ansFlag ranOK SC1.A1ModJulian SC1.ElapsedSecs SC1.TA SC1.X SC1.Y SC1.Z;
    GMAT While42_24.WriteHeaders = Off;
