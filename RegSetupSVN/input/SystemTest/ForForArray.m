%% $Id: ForForArray.m,v 1.4 2007/07/26 19:13:11 edove Exp $
...
Create ReportFile ForForArray;
GMAT ForForArray.Filename = ./output/SystemTest/ForForArray.report;
GMAT ForForArray.Precision = 15;
...
BeginScript;
    ...
    For I = 1:2;
        For StepSize = 1:5;
            ...
            Report      ForForArray type ansFlag ranOK SC1.A1ModJulian SC1.ElapsedSecs SC1.TA SC1.X SC1.Y SC1.Z; 
            GMAT ForForArray.WriteHeaders = Off;
        EndFor;
    EndFor;
