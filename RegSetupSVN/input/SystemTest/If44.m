% REVISION HISTORY
% $Id: If44.m,v 1.2 2007/07/26 19:13:12 edove Exp $
...
Create ReportFile If44;
GMAT If44.Filename = ./output/SystemTest/If44.report;
GMAT If44.Precision = 15;
...
BeginScript;
    ...
    EndIf;
    Report      If44 type ansFlag SC1.A1ModJulian SC1.ElapsedSecs SC1.TA SC1.X SC1.Y SC1.Z;
    GMAT If44.WriteHeaders = Off;
