% REVISION HISTORY
% $Id: If55.m,v 1.2 2007/07/26 19:13:12 edove Exp $
...
Create ReportFile If55;
GMAT If55.Filename = ./output/SystemTest/If55.report;
GMAT If55.Precision = 15;
...
BeginScript;
    ...
    EndIf;
    Report      If55 type ansFlag SC1.A1ModJulian SC1.ElapsedSecs SC1.TA SC1.X SC1.Y SC1.Z;
    GMAT If55.WriteHeaders = Off;
