...
Create CoordinateSystem UranusLVLH;
UranusLVLH.Axes = ObjectReferenced;
UranusLVLH.Origin = Sc;
UranusLVLH.Primary = Uranus;
UranusLVLH.Secondary = Sc;
UranusLVLH.ZAxis = R;
UranusLVLH.YAxis = -N;
 
%-----  Thruster E;
Create Thruster engine1;
GMAT engine1.CoordinateSystem = UranusLVLH;
...
GMAT rf.Filename = '.\output\SystemTest\FBurn_GMAT_Uranus_ScA_ThrusterE_CS2_TankA_output.report';
