%% $Id: CbUranus2Body.m,v 1.2 2007/07/26 19:13:11 edove Exp $

Create Spacecraft UranusSC;
GMAT UranusSC.DateFormat = UTCGregorian
GMAT UranusSC.Epoch = '01 Jun 2004 12:00:00.000';
...
GMAT Uranus_Report.Filename = ./output/SystemTest/CbUranus2Body.report;
