%% $Id: IfForArray.m,v 1.4 2007/07/26 19:13:12 edove Exp $
...
Create ReportFile IfForArray;
GMAT IfForArray.Filename = ./output/SystemTest/IfForArray.report;
GMAT IfForArray.Precision = 15;
...
BeginScript;
    ...
    If SC1.A1ModJulian > 5
        For StepSize = 1:5
            ...
            Report      IfForArray type ansFlag ranOK SC1.A1ModJulian SC1.ElapsedSecs SC1.TA SC1.X SC1.Y SC1.Z; 
        EndFor;
        GMAT ranOK = ranOK - 4;
    EndIf;
    GMAT IfForArray.WriteHeaders = Off;
    Report      IfForArray type ansFlag ranOK SC1.A1ModJulian SC1.ElapsedSecs SC1.TA SC1.X SC1.Y SC1.Z;
    GMAT SC1.TA = 145;
