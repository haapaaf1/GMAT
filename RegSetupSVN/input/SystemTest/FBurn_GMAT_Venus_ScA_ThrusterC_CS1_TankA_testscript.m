...
Create CoordinateSystem VenusVNB;
VenusVNB.Axes = ObjectReferenced;
VenusVNB.Origin = Sc;
VenusVNB.Primary = Venus;
VenusVNB.Secondary = Sc;
VenusVNB.XAxis = V;
VenusVNB.YAxis = N;
 
%-----  Thruster C;
Create Thruster engine1;
GMAT engine1.CoordinateSystem = VenusVNB;
...
GMAT rf.Filename = '.\output\SystemTest\FBurn_GMAT_Venus_ScA_ThrusterC_CS1_TankA_output.report';
