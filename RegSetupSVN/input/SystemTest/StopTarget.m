%$Id: StopTarget.m,v 1.9 2008/04/18 13:42:11 lojun Exp $ 
...
Create ReportFile burn1Report;
GMAT burn1Report.Filename = ./output/SystemTest/StopTargetManeuver.report;
GMAT burn1Report.Precision = 15;
GMAT burn1Report.WriteHeaders = On;
GMAT burn1Report.LeftJustify = On;
GMAT burn1Report.ZeroFill = Off;
GMAT burn1Report.ColumnWidth = 20;
GMAT burn1Report.SolverIterations = None;

Create ReportFile stopReport;
GMAT stopReport.Filename = ./output/SystemTest/StopTarget.report;
