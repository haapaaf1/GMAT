%$Id: StopWhileFor.m,v 1.8 2007/11/20 22:37:14 edove Exp $ 
...
GMAT stopReport.Filename = ./output/SystemTest/StopWhileFor.report;
...
EndWhile;
Target DefaultDC;
   Vary DefaultDC(Burn1.Element1 = 0.5, {Perturbation = 0.0001, MaxStep = 0.2, Lower = 0, ...
       Upper = 3.14159, AdditiveScaleFactor = 0, MultiplicativeScaleFactor = 1});
   Propagate DefaultProp(Sat) {Sat.ElapsedSecs = 8640.0};
   Report stopReport Sat.ElapsedSecs Sat.SMA Sat.ECC Sat.INC Sat.RAAN ...
       Sat.AOP Sat.TA Sat.BetaAngle;
