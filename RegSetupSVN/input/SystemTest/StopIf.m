%$Id: StopIf.m,v 1.8 2008/04/18 13:42:11 lojun Exp $ 
...
GMAT stopReport.Filename = ./output/SystemTest/StopIf.report;
...
EndTarget;  % For targeter DefaultDC  % For targeter DefaultDC  % For targeter DefaultDC  % For targeter DefaultDC
