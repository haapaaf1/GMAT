...
GMAT Sc.CoordinateSystem = MoonMJ2000Eq;
GMAT Sc.DisplayStateType = Keplerian;
GMAT Sc.SMA = 2737.500000000028;
...
GMAT Sc.AttitudeCoordinateSystem = 'MoonMJ2000Eq';
GMAT Sc.Q1 = 0;
GMAT Sc.Q2 = 0;
GMAT Sc.Q3 = 0;
GMAT Sc.Q4 = 1;
...
Create CoordinateSystem MoonLVLH;
MoonLVLH.Axes = ObjectReferenced;
MoonLVLH.Origin = Sc;
MoonLVLH.Primary = Luna;
MoonLVLH.Secondary = Sc;
MoonLVLH.ZAxis = R;
MoonLVLH.YAxis = -N;
 
%-----  Thruster F;
Create Thruster engine1;
GMAT engine1.CoordinateSystem = MoonLVLH;
...
GMAT rf.Filename = '.\output\SystemTest\FBurn_GMAT_Moon_ScA_ThrusterF_CS2_TankA_output.report';
