% REVISION HISTORY
% $Id: WhileWhile42_24.m,v 1.2 2007/07/26 19:13:12 edove Exp $
...
Create ReportFile WhileWhile42_24;
GMAT WhileWhile42_24.Filename = ./output/SystemTest/WhileWhile42_24.report;
GMAT WhileWhile42_24.Precision = 15;
...
BeginScript;
    ...
    While count < 5.5
        ...
        While SC1.TA == testVar
            ...
            Report      WhileWhile42_24 type ansFlag ranOK SC1.A1ModJulian SC1.ElapsedSecs SC1.TA SC1.X SC1.Y SC1.Z;
            GMAT WhileWhile42_24.WriteHeaders = Off;
        EndWhile;   
        GMAT count = count + 1;
        Report      WhileWhile42_24 type ansFlag ranOK SC1.A1ModJulian SC1.ElapsedSecs SC1.TA SC1.X SC1.Y SC1.Z;
        GMAT WhileWhile42_24.WriteHeaders = Off;
