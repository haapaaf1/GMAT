...
GMAT Sc.CoordinateSystem = JupiterMJ2000Eq;
...
GMAT Sc.AttitudeCoordinateSystem = 'JupiterMJ2000Eq';
GMAT Sc.Q1 = 0;
GMAT Sc.Q2 = 0;
GMAT Sc.Q3 = 0;
GMAT Sc.Q4 = 1;
...
Create CoordinateSystem JupiterLVLH;
JupiterLVLH.Axes = ObjectReferenced;
JupiterLVLH.Origin = Sc;
JupiterLVLH.Primary = Jupiter;
JupiterLVLH.Secondary = Sc;
JupiterLVLH.ZAxis = R;
JupiterLVLH.YAxis = -N;
 
%-----  Thruster A;
Create Thruster engine1;
GMAT engine1.CoordinateSystem = JupiterLVLH;
...
GMAT JupiterMJ2000Eq.UpdateInterval = 60;
GMAT JupiterMJ2000Eq.OverrideOriginInterval = false;
...
GMAT fm.CentralBody = Jupiter;
GMAT fm.PointMasses = {Jupiter};
GMAT fm.Drag = None;
GMAT fm.SRP = Off;
...
GMAT rf.Filename = '.\output\SystemTest\FBurn_GMAT_Jupiter_ScA_ThrusterA_CS2_TankA_output.report';
GMAT rf.Precision = 16;
GMAT rf.Add = {Sc.TAIModJulian, Sc.Jupiter.SMA, Sc.Jupiter.ECC, Sc.JupiterMJ2000Eq.INC, Sc.JupiterMJ2000Eq.RAAN, Sc.JupiterMJ2000Eq.AOP, Sc.Jupiter.TA, Sc.TotalMass};
