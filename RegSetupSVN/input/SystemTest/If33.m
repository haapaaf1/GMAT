% REVISION HISTORY
% $Id: If33.m,v 1.2 2007/07/26 19:13:11 edove Exp $
...
Create ReportFile If33;
GMAT If33.Filename = ./output/SystemTest/If33.report;
GMAT If33.Precision = 15;
...
BeginScript;
    ...
    EndIf;
    Report      If33 type ansFlag SC1.A1ModJulian SC1.ElapsedSecs SC1.TA SC1.X SC1.Y SC1.Z;
    GMAT If33.WriteHeaders = Off;
