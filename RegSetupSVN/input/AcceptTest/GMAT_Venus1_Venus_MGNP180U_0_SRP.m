%% $Id: GMAT_Venus1_Venus_MGNP180U_0_SRP.m,v 1.5 2007/08/10 21:15:03 edove Exp $
...
Create ForceModel MGNP180U;
GMAT MGNP180U.CentralBody = Venus;
GMAT MGNP180U.PrimaryBodies = {Venus};
GMAT MGNP180U.Drag = None;
GMAT MGNP180U.SRP = On;
GMAT MGNP180U.SRP.Flux_Pressure = 4.53443218374393e-006;
GMAT MGNP180U.ErrorControl = RSSStep;
GMAT MGNP180U.Gravity.Venus.PotentialFile = ./files/gravity/venus/MGNP180U.cof;
GMAT MGNP180U.Gravity.Venus.Degree = 20;
GMAT MGNP180U.Gravity.Venus.Order = 20;

Create Propagator RKV89;
GMAT RKV89.FM = MGNP180U;
...
GMAT Venus_Report.Filename = ./output/AcceptTest/GMAT_Venus1_Venus_MGNP180U_0_SRP.report;
