%% $Id: Integrator_GMAT_GEO_RKF56_2Body.m,v 1.4 2007/07/26 19:12:29 edove Exp $
...
Create Propagator RKF56;
GMAT RKF56.FM = Earth2Body;
GMAT RKF56.Type = RungeKuttaFehlberg56;
GMAT RKF56.InitialStepSize = 60;
GMAT RKF56.Accuracy = 1e-013;
GMAT RKF56.MinStep = 60;
GMAT RKF56.MaxStep = 60;
GMAT RKF56.MaxStepAttempts = 50; 
 
GMAT SolarSystem.EphemerisUpdateInterval = 0.0;
GMAT SolarSystem.Earth.NutationUpdateInterval = 60.0; 

Create ReportFile GEO_Report
GMAT GEO_Report.Filename = ./output/AcceptTest/Integrator_GMAT_GEO_RKF56_2Body.report;
...
For OutputStepSize = 1:1008;
	Propagate   RKF56(GEO, {GEO.ElapsedSecs = 600});
	Report      GEO_Report GEO.A1ModJulian GEO.X GEO.Y GEO.Z GEO.VX GEO.VY GEO.VZ;
EndFor ;
