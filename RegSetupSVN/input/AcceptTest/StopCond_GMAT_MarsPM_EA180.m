%% $Id: StopCond_GMAT_MarsPM_EA180.m,v 1.2 2007/07/26 19:12:31 edove Exp $
...
GMAT StopCond_Report.Filename = ./output/AcceptTest/StopCond_GMAT_MarsPM_EA180.report;
GMAT StopCond_Report.Precision = 16;
GMAT StopCond_Report.WriteHeaders = On;
GMAT StopCond_Report.ColumnWidth = 20;

Propagate DefaultProp(DefaultSC, {DefaultSC.Mars.EA = 180});
Report StopCond_Report DefaultSC.A1ModJulian DefaultSC.Mars.EA;
