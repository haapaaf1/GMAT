%% $Id: Loop_GMAT_ForIf43_34.m,v 1.4 2007/07/26 19:12:29 edove Exp $
...
Create ReportFile Loop_GMAT_ForIf43_34;
GMAT Loop_GMAT_ForIf43_34.Filename = ./output/AcceptTest/Loop_GMAT_ForIf43_34.report;
GMAT Loop_GMAT_ForIf43_34.Precision = 15;
...
BeginScript;
   ...
   For StepSize = 1:5;
       ...
       EndIf;
        Report      Loop_GMAT_ForIf43_34 type ansFlag ranOK SC1.A1ModJulian SC1.ElapsedSecs SC1.TA SC1.X SC1.Y SC1.Z;
   EndFor;
    GMAT Loop_GMAT_ForIf43_34.WriteHeaders = Off;
   Report      Loop_GMAT_ForIf43_34 type ansFlag ranOK SC1.A1ModJulian SC1.ElapsedSecs SC1.TA SC1.X SC1.Y SC1.Z;
   GMAT SC1.TA = 145;
