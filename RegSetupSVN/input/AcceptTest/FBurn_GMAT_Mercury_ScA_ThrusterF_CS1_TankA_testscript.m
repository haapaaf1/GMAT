...
Create CoordinateSystem MercuryVNB;
MercuryVNB.Axes = ObjectReferenced;
MercuryVNB.Origin = Sc;
MercuryVNB.Primary = Mercury;
MercuryVNB.Secondary = Sc;
MercuryVNB.XAxis = V;
MercuryVNB.YAxis = N;
 
%-----  Thruster F;
Create Thruster engine1;
GMAT engine1.CoordinateSystem = MercuryVNB;
...
GMAT rf.Filename = '.\output\AcceptTest\FBurn_GMAT_Mercury_ScA_ThrusterF_CS1_TankA_output.report';
