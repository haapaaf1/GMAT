%% $Id: Integrator_GMAT_GEO_PD78_2Body.m,v 1.4 2007/07/26 19:12:29 edove Exp $
...
GMAT PD78.Accuracy = 1e-013;
GMAT PD78.MinStep = 60;
GMAT PD78.MaxStep = 60;
...
GMAT GEO_Report.Filename = ./output/AcceptTest/Integrator_GMAT_GEO_PD78_2Body.report;
...
For OutputStepSize = 1:1008;
	Propagate   PD78(GEO, {GEO.ElapsedSecs = 600});
	Report      GEO_Report GEO.A1ModJulian GEO.X GEO.Y GEO.Z GEO.VX GEO.VY GEO.VZ;
EndFor ;
