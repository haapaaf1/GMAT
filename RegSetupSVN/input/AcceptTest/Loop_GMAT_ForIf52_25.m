%% $Id: Loop_GMAT_ForIf52_25.m,v 1.4 2007/07/26 19:12:29 edove Exp $
...
Create ReportFile Loop_GMAT_ForIf52_25;
GMAT Loop_GMAT_ForIf52_25.Filename = ./output/AcceptTest/Loop_GMAT_ForIf52_25.report;
GMAT Loop_GMAT_ForIf52_25.Precision = 15;
...
BeginScript;
   ...
   For StepSize = 1:5;
       ...
       EndIf;
        Report      Loop_GMAT_ForIf52_25 type ansFlag ranOK SC1.A1ModJulian SC1.ElapsedSecs SC1.TA SC1.X SC1.Y SC1.Z;
   EndFor;
    GMAT Loop_GMAT_ForIf52_25.WriteHeaders = Off;
   Report      Loop_GMAT_ForIf52_25 type ansFlag ranOK SC1.A1ModJulian SC1.ElapsedSecs SC1.TA SC1.X SC1.Y SC1.Z;
   GMAT SC1.TA = 145;
