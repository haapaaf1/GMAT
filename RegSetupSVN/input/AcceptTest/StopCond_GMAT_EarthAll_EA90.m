%% $Id: StopCond_GMAT_EarthAll_EA90.m,v 1.3 2007/08/10 21:15:03 edove Exp $
...
GMAT StopCond_Report.Filename = ./output/AcceptTest/StopCond_GMAT_EarthAll_EA90.report;
GMAT StopCond_Report.Precision = 16;
GMAT StopCond_Report.WriteHeaders = On;
GMAT StopCond_Report.ColumnWidth = 20;

Propagate DefaultProp(DefaultSC, {DefaultSC.Earth.EA = 90});
