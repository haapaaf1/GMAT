%% $Id: Loop_GMAT_For.m,v 1.5 2007/07/26 19:12:29 edove Exp $

%   REVISION HISTORY
%   Author      Date            Comment
%               (MM/DD/YYYY)
%   E.Dove      07/03/2006      Original
%   E.Dove      04/10/2007      Last Modified
...
GMAT Loop_GMAT_For.Filename = ./output/AcceptTest/Loop_GMAT_For.report;
GMAT Loop_GMAT_For.Precision = 15;

Create Array testArray[2,1];
Create Variable testVar1;
Create Variable testVar2;
Create Variable type count Ivar StepSize;
