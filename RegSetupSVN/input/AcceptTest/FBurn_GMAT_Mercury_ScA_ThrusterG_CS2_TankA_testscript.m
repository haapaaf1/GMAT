...
Create CoordinateSystem MercuryLVLH;
MercuryLVLH.Axes = ObjectReferenced;
MercuryLVLH.Origin = Sc;
MercuryLVLH.Primary = Mercury;
MercuryLVLH.Secondary = Sc;
MercuryLVLH.ZAxis = R;
MercuryLVLH.YAxis = -N;
 
%-----  Thruster G;
Create Thruster engine1;
GMAT engine1.CoordinateSystem = MercuryLVLH;
...
GMAT rf.Filename = '.\output\AcceptTest\FBurn_GMAT_Mercury_ScA_ThrusterG_CS2_TankA_output.report';
