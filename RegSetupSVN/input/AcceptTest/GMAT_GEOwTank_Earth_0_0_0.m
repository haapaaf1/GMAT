%% $Id: GMAT_GEOwTank_Earth_0_0_0.m,v 1.4 2007/07/26 19:12:28 edove Exp $
...
Create Spacecraft GEO;
 ...
 GMAT GEO.SRPArea = 20;
 GMAT GEO.DryMass = 700;
 GMAT GEO.Tanks = {Tank1};
...
GMAT GEO_Report.Filename = ./output/AcceptTest/GMAT_GEOwTank_Earth_0_0_0.report;
