%% $Id: Loop_GMAT_If11.m,v 1.3 2007/07/26 19:12:29 edove Exp $
...
Create ReportFile Loop_GMAT_If11;
GMAT Loop_GMAT_If11.Filename = ./output/AcceptTest/Loop_GMAT_If11.report;
GMAT Loop_GMAT_If11.Precision = 15;
...
BeginScript;
    ...
    EndIf;
    Report      Loop_GMAT_If11 type ansFlag SC1.A1ModJulian SC1.ElapsedSecs SC1.TA SC1.X SC1.Y SC1.Z;
    GMAT Loop_GMAT_If11.WriteHeaders = Off;
