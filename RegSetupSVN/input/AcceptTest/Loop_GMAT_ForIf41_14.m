%% $Id: Loop_GMAT_ForIf41_14.m,v 1.6 2007/07/26 19:12:29 edove Exp $
...
Create ReportFile Loop_GMAT_ForIf41_14;
GMAT Loop_GMAT_ForIf41_14.Filename = ./output/AcceptTest/Loop_GMAT_ForIf41_14.report;
GMAT Loop_GMAT_ForIf41_14.Precision = 15;
...
BeginScript;
   ...
   For StepSize = 1:5;
       ...
       EndIf;
        Report      Loop_GMAT_ForIf41_14 type ansFlag ranOK SC1.A1ModJulian SC1.ElapsedSecs SC1.TA SC1.X SC1.Y SC1.Z;
   EndFor;
    GMAT Loop_GMAT_ForIf41_14.WriteHeaders = Off;
   Report      Loop_GMAT_ForIf41_14 type ansFlag ranOK SC1.A1ModJulian SC1.ElapsedSecs SC1.TA SC1.X SC1.Y SC1.Z;
   GMAT SC1.TA = 145;

    % ===== 2 ====== Currently not supported in GMAT
    GMAT type = type + 1;
%    GMAT ranOK = 0;
%   GMAT ranOK = 1;
%   For StepSize = 1:5;
...
%   GMAT SC1.TA = 145;
    ...
    % ===== 4 ====== Currently not supported in GMAT
    GMAT type = type + 1;
%    GMAT ranOK = 1;
%    GMAT SC1.TA = 5;
%    For StepSize = 1:5;
...
%   GMAT SC1.TA = 145;
    ...
    % ===== 14 ====== Currently not supported in GMAT
    GMAT type = type + 1;
%    GMAT ranOK = 1;
%    For StepSize = 1:5;
%        GMAT SC1.TA = 5;
