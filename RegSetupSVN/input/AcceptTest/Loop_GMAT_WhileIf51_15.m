%% $Id: Loop_GMAT_WhileIf51_15.m,v 1.3 2007/07/26 19:12:30 edove Exp $
...
Create ReportFile Loop_GMAT_WhileIf51_15;
GMAT Loop_GMAT_WhileIf51_15.Filename = ./output/AcceptTest/Loop_GMAT_WhileIf51_15.report;
GMAT Loop_GMAT_WhileIf51_15.Precision = 15;
...
BeginScript;
   ...
   While count < 5.5
       ...
       EndIf;
        Report      Loop_GMAT_WhileIf51_15 type ansFlag ranOK SC1.A1ModJulian SC1.ElapsedSecs SC1.TA SC1.X SC1.Y SC1.Z; 
       GMAT count = count + 1;
        GMAT Loop_GMAT_WhileIf51_15.WriteHeaders = Off;
   EndWhile;
   GMAT SC1.TA = 145;
