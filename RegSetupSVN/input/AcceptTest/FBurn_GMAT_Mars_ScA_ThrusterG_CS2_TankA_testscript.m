...
GMAT Sc.CoordinateSystem = MarsMJ2000Eq;
...
GMAT Sc.AttitudeCoordinateSystem = 'MarsMJ2000Eq';
GMAT Sc.Q1 = 0;
GMAT Sc.Q2 = 0;
GMAT Sc.Q3 = 0;
GMAT Sc.Q4 = 1;
...
Create CoordinateSystem MarsLVLH;
MarsLVLH.Axes = ObjectReferenced;
MarsLVLH.Origin = Sc;
MarsLVLH.Primary = Mars;
MarsLVLH.Secondary = Sc;
MarsLVLH.ZAxis = R;
MarsLVLH.YAxis = -N;
 
%-----  Thruster G;
Create Thruster engine1;
GMAT engine1.CoordinateSystem = MarsLVLH;
...
GMAT rf.Filename = '.\output\AcceptTest\FBurn_GMAT_Mars_ScA_ThrusterG_CS2_TankA_output.report';
