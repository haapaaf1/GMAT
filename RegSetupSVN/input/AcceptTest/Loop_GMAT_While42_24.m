%% $Id: Loop_GMAT_While42_24.m,v 1.3 2007/07/26 19:12:30 edove Exp $

%   REVISION HISTORY
%   Author      Date            Comment
%               (MM/DD/YYYY)
%   E.Dove      06/30/2006      Original
%   E.Dove      12/08/2006      Last Modified
...
Create ReportFile Loop_GMAT_While42_24;
GMAT Loop_GMAT_While42_24.Filename = ./output/AcceptTest/Loop_GMAT_While42_24.report;
GMAT Loop_GMAT_While42_24.Precision = 15;
...
BeginScript;
   ...
   While SC1.TA == testVar
       ...
       Report      Loop_GMAT_While42_24 type ansFlag ranOK SC1.A1ModJulian SC1.ElapsedSecs SC1.TA SC1.X SC1.Y SC1.Z;
       GMAT Loop_GMAT_While42_24.WriteHeaders = Off;
   EndWhile;   
    Report      Loop_GMAT_While42_24 type ansFlag ranOK SC1.A1ModJulian SC1.ElapsedSecs SC1.TA SC1.X SC1.Y SC1.Z;
    GMAT Loop_GMAT_While42_24.WriteHeaders = Off;
   ...
   GMAT ranOK = ranOK - 1;
    ...
    While SC1.TA >= testVar
        ...
        GMAT ranOK = ranOK + 1;
    EndWhile;
    GMAT ranOK = testVar - (SC1.TA + 0.00001);
    Report      Loop_GMAT_While42_24 type ansFlag ranOK SC1.A1ModJulian SC1.ElapsedSecs SC1.TA SC1.X SC1.Y SC1.Z;
