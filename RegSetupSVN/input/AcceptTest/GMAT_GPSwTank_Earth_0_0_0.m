%% $Id: GMAT_GPSwTank_Earth_0_0_0.m,v 1.4 2007/07/26 19:12:28 edove Exp $
...
GMAT GPS.SRPArea = 20;
GMAT GPS.DryMass = 700;
GMAT GPS.Tanks = {Tank1};
...
GMAT GPS_Report.Filename = ./output/AcceptTest/GMAT_GPSwTank_Earth_0_0_0.report;
