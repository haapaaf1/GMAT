%% $Id: Loop_GMAT_ForWhile42.m,v 1.5 2007/07/26 19:12:29 edove Exp $

%   REVISION HISTORY
%   Author      Date            Comment
%               (MM/DD/YYYY)
%   E.Dove      08/08/2006      Original
%   E.Dove      03/15/2007      Last Modified
...
Create ReportFile Loop_GMAT_ForWhile42;
GMAT Loop_GMAT_ForWhile42.Filename = ./output/AcceptTest/Loop_GMAT_ForWhile42.report;
GMAT Loop_GMAT_ForWhile42.Precision = 15;
...
BeginScript;
   ...
   For StepSize = 1:5;
      ...
      While SC1.TA == testVar
          ...
          Report      Loop_GMAT_ForWhile42 type ansFlag ranOK SC1.A1ModJulian SC1.ElapsedSecs SC1.TA SC1.X SC1.Y SC1.Z;
          GMAT Loop_GMAT_ForWhile42.WriteHeaders = Off;
      EndWhile;
   EndFor;
    Report      Loop_GMAT_ForWhile42 type ansFlag ranOK SC1.A1ModJulian SC1.ElapsedSecs SC1.TA SC1.X SC1.Y SC1.Z;
    GMAT Loop_GMAT_ForWhile42.WriteHeaders = Off;
