...
Create CoordinateSystem JupiterVNB;
JupiterVNB.Axes = ObjectReferenced;
JupiterVNB.Origin = Sc;
JupiterVNB.Primary = Jupiter;
JupiterVNB.Secondary = Sc;
JupiterVNB.XAxis = V;
JupiterVNB.YAxis = N;
 
%-----  Thruster F;
Create Thruster engine1;
GMAT engine1.CoordinateSystem = JupiterVNB;
...
GMAT rf.Filename = '.\output\AcceptTest\FBurn_GMAT_Jupiter_ScA_ThrusterF_CS1_TankA_output.report';
