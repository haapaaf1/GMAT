%% $Id: Integrator_GMAT_ISS_RKF56_2Body.m,v 1.4 2007/07/26 19:12:29 edove Exp $
...
GMAT RKF56.InitialStepSize = 5;
GMAT RKF56.Accuracy = 1e-013;
GMAT RKF56.MinStep = 5;
GMAT RKF56.MaxStep = 5;
...
GMAT ISS_Report.Filename = ./output/AcceptTest/Integrator_GMAT_ISS_RKF56_2Body.report;
...
For OutputStepSize = 1:1440;
	Propagate   RKF56(ISS, {ISS.ElapsedSecs = 60});
	Report      ISS_Report ISS.A1ModJulian ISS.X ISS.Y ISS.Z ISS.VX ISS.VY ISS.VZ;
EndFor ;
