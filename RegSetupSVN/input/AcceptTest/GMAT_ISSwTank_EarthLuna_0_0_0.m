%% $Id: GMAT_ISSwTank_EarthLuna_0_0_0.m,v 1.4 2007/07/26 19:12:28 edove Exp $
...
GMAT ISS.SRPArea = 20;
GMAT ISS.DryMass = 700;
GMAT ISS.Tanks = {Tank1};
...
GMAT Earth2Body.PointMasses   = {Luna};
...
GMAT ISS_Report.Filename = ./output/AcceptTest/GMAT_ISSwTank_EarthLuna_0_0_0.report;
