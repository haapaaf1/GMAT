%% $Id: Loop_GMAT_WhileFor.m,v 1.4 2007/07/26 19:12:30 edove Exp $
...
Create ReportFile Loop_GMAT_WhileFor;
GMAT Loop_GMAT_WhileFor.Filename = ./output/AcceptTest/Loop_GMAT_WhileFor.report;
GMAT Loop_GMAT_WhileFor.Precision = 15;
...
BeginScript;
    ...
    While count < 5.5
        ...
        For StepSize = 1:5
            ...
            Report      Loop_GMAT_WhileFor type ansFlag ranOK SC1.A1ModJulian SC1.ElapsedSecs SC1.TA SC1.X SC1.Y SC1.Z; 
        EndFor;
        GMAT ranOK = ranOK - 4;
        GMAT count = count + 1;
        GMAT Loop_GMAT_WhileFor.WriteHeaders = Off;
        Report      Loop_GMAT_WhileFor type ansFlag ranOK SC1.A1ModJulian SC1.ElapsedSecs SC1.TA SC1.X SC1.Y SC1.Z; 
        GMAT ranOK = 0;
    EndWhile;
    GMAT ranOK = ranOK + 1;
