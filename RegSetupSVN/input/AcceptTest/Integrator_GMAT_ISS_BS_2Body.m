%% $Id: Integrator_GMAT_ISS_BS_2Body.m,v 1.4 2007/07/26 19:12:29 edove Exp $
...
GMAT ISS_Report.Filename = ./output/AcceptTest/Integrator_GMAT_ISS_BS_2Body.report;
...
For OutputStepSize = 1:1440;
	Propagate   BS(ISS, {ISS.ElapsedSecs = 60});
	Report      ISS_Report ISS.A1ModJulian ISS.X ISS.Y ISS.Z ISS.VX ISS.VY ISS.VZ;
EndFor ;
