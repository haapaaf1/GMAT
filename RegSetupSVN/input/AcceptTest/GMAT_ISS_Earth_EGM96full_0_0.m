%% $Id: GMAT_ISS_Earth_EGM96full_0_0.m,v 1.1 2007/09/20 21:33:02 edove Exp $
...
GMAT EarthEGM96.Gravity.Earth.Degree = 70;
GMAT EarthEGM96.Gravity.Earth.Order = 70;
...
GMAT SolarSystem.Earth.NutationUpdateInterval = 0.0; 

Create ReportFile ISS_Report
GMAT ISS_Report.Filename = ./output/AcceptTest/GMAT_ISS_Earth_EGM96full_0_0.report;
