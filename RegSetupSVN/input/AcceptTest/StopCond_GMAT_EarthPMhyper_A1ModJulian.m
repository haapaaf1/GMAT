%% $Id: StopCond_GMAT_EarthPMhyper_A1ModJulian.m,v 1.3 2007/07/26 19:12:31 edove Exp $
...
GMAT StopCond_Report.Filename = ./output/AcceptTest/StopCond_GMAT_EarthPMhyper_A1ModJulian.report;
GMAT StopCond_Report.Precision = 16;
GMAT StopCond_Report.WriteHeaders = On;
GMAT StopCond_Report.ColumnWidth = 20;

Propagate DefaultProp(DefaultSC, {DefaultSC.A1ModJulian = 23158.042037434974});
Report StopCond_Report DefaultSC.A1ModJulian DefaultSC.A1ModJulian;
