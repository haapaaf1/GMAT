%% $Id: StopCond_GMAT_MoonPM_Periapsis.m,v 1.3 2007/07/26 19:12:31 edove Exp $
...
GMAT StopCond_Report.Filename = ./output/AcceptTest/StopCond_GMAT_MoonPM_Periapsis.report;
