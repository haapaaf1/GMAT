%% $Id: Loop_GMAT_While52_25.m,v 1.3 2007/07/26 19:12:30 edove Exp $
...
Create ReportFile Loop_GMAT_While52_25;
GMAT Loop_GMAT_While52_25.Filename = ./output/AcceptTest/Loop_GMAT_While52_25.report;
GMAT Loop_GMAT_While52_25.Precision = 15;
...
BeginScript;
   ...
   While SC1.A1ModJulian == testVar
       ...
       GMAT testVar = 5;
       Report      Loop_GMAT_While52_25 type ansFlag ranOK SC1.A1ModJulian SC1.ElapsedSecs SC1.TA SC1.X SC1.Y SC1.Z;
       GMAT Loop_GMAT_While52_25.WriteHeaders = Off;
   EndWhile;
    Report      Loop_GMAT_While52_25 type ansFlag ranOK SC1.A1ModJulian SC1.ElapsedSecs SC1.TA SC1.X SC1.Y SC1.Z;
    GMAT Loop_GMAT_While52_25.WriteHeaders = Off;
   ...
   GMAT ranOK = ranOK - 1;
    ...
    % ===== 5 ======
    GMAT type = type + 1;
    GMAT testVar = SC1.A1ModJulian - (1/400);
    GMAT ansFlag = 0;
    GMAT ranOK = 0;
    While SC1.A1ModJulian > testVar
        GMAT ansFlag = 1;
        ...
        Propagate   DefaultProp(SC1);
        Report      Loop_GMAT_While52_25 type ansFlag ranOK SC1.A1ModJulian SC1.ElapsedSecs SC1.TA SC1.X SC1.Y SC1.Z;
        GMAT testVar = testVar + (1/720);
        GMAT ranOK = ranOK + 1;
    EndWhile;
    GMAT ranOK = testVar - SC1.A1ModJulian;
    Report      Loop_GMAT_While52_25 type ansFlag ranOK SC1.A1ModJulian SC1.ElapsedSecs SC1.TA SC1.X SC1.Y SC1.Z;
...
BeginScript;
   ...
   EndWhile;
    ...
    While testVar <= SC1.A1ModJulian
        ...
        GMAT ranOK = ranOK + 1;
    EndWhile;
    GMAT ranOK = testVar - (SC1.A1ModJulian + 0.00001);
    Report      Loop_GMAT_While52_25 type ansFlag ranOK SC1.A1ModJulian SC1.ElapsedSecs SC1.TA SC1.X SC1.Y SC1.Z;
EndScript;