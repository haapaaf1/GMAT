%% $Id: CSParams_GMAT_ISS_2Body_EarthGSM.m,v 1.4 2007/07/26 19:12:27 edove Exp $
...
Create CoordinateSystem EarthGSM;
GMAT EarthGSM.Origin = Earth;
GMAT EarthGSM.Axes = GSM;
GMAT EarthGSM.UpdateInterval = 0;

Create ReportFile ISS_Report
GMAT ISS_Report.Filename = ./output/AcceptTest/CSParams_GMAT_ISS_2Body_EarthGSM.report;
...
Report      ISS_Report ISS.A1ModJulian ISS.EarthGSM.X ISS.EarthGSM.Y ISS.EarthGSM.Z ISS.EarthGSM.VX ISS.EarthGSM.VY ISS.EarthGSM.VZ ISS.EarthGSM.VMAG ISS.EarthGSM.RAV ISS.EarthGSM.HX ISS.EarthGSM.HY ISS.EarthGSM.HZ ISS.EarthGSM.AOP ISS.EarthGSM.DEC ISS.EarthGSM.DECV ISS.EarthGSM.INC ISS.EarthGSM.RA ISS.EarthGSM.RAAN;
