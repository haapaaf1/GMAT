%% $Id: CbParams_GMAT_ISS_2Body.m,v 1.4 2007/07/26 19:12:26 edove Exp $
...
GMAT ISS_Report.Filename = ./output/AcceptTest/CbParams_GMAT_ISS_2Body.report;
...
Report ISS_Report ISS.A1ModJulian ISS.Earth.Altitude ISS.Earth.BetaAngle ISS.Earth.C3Energy ISS.Earth.ECC ISS.Earth.Latitude ISS.Earth.Longitude ISS.Earth.HMAG ISS.Earth.MA ISS.Earth.MM ISS.Earth.OrbitPeriod ISS.Earth.RadApo ISS.Earth.RadPer ISS.Earth.RMAG ISS.Earth.SMA ISS.Earth.TA ISS.Earth.SemilatusRectum ISS.Earth.VelApoapsis ISS.Earth.VelPeriapsis ISS.Earth.MHA ISS.Earth.LST;
