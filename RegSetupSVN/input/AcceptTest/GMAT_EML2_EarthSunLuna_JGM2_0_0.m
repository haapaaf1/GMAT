% Earth Moon L2 orbit%% $Id: GMAT_EML2_EarthSunLuna_JGM2_0_0.m,v 1.5 2007/08/10 21:15:02 edove Exp $
...
GMAT Earth2Body.PointMasses = {Sun, Luna};
GMAT Earth2Body.Drag = None;
GMAT Earth2Body.Gravity.Earth.Model = ./files/gravity/earth/JGM2.cof;
GMAT Earth2Body.Gravity.Earth.Degree = 4;
GMAT Earth2Body.Gravity.Earth.Order = 4;
...
GMAT EML2_Report.Filename = ./output/AcceptTest/GMAT_EML2_EarthSunLuna_JGM2_0_0.report;
