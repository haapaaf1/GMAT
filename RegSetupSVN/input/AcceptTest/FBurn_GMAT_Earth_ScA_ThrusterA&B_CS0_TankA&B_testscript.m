...
GMAT engine2.CoordinateSystem = EarthMJ2000Eq;
 
GMAT engine2.Element1 = 0.5774;
GMAT engine2.Element2 = 0.5774;
GMAT engine2.Element3 = 0.5774;
GMAT engine2.DutyCycle = 1;
GMAT engine2.ThrustScaleFactor = 1;
GMAT engine2.DecrementMass = true;
GMAT engine2.Tank = {tank1};
GMAT engine2.GravitationalAccel = 9.81;
GMAT engine2.C1 = 10;
GMAT engine2.C2 = 0;
GMAT engine2.C3 = 0;
GMAT engine2.C4 = 0;
...
GMAT tank2.FuelMass = 820;
GMAT tank2.Pressure = 1200;
GMAT tank2.Temperature = 20;
GMAT tank2.RefTemperature = 12;
GMAT tank2.Volume = 0.8;
GMAT tank2.FuelDensity = 1029;
GMAT tank2.PressureModel = PressureRegulated;
...
GMAT rf.Filename = '.\output\AcceptTest\FBurn_GMAT_Earth_ScA_ThrusterA&B_CS0_TankA&B_output.report';
