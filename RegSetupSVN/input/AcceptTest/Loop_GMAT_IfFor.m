%% $Id: Loop_GMAT_IfFor.m,v 1.4 2007/07/26 19:12:30 edove Exp $
...
Create ReportFile Loop_GMAT_IfFor;
GMAT Loop_GMAT_IfFor.Filename = ./output/AcceptTest/Loop_GMAT_IfFor.report;
GMAT Loop_GMAT_IfFor.Precision = 15;
...
BeginScript;
    ...
    If SC1.A1ModJulian > 5
        For StepSize = 1:5
            ...
            Report      Loop_GMAT_IfFor type ansFlag ranOK SC1.A1ModJulian SC1.ElapsedSecs SC1.TA SC1.X SC1.Y SC1.Z; 
        EndFor;
        GMAT ranOK = ranOK - 4;
    EndIf;
    GMAT Loop_GMAT_IfFor.WriteHeaders = Off;
    Report      Loop_GMAT_IfFor type ansFlag ranOK SC1.A1ModJulian SC1.ElapsedSecs SC1.TA SC1.X SC1.Y SC1.Z;
    GMAT SC1.TA = 145;
