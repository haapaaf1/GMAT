%% $Id: StopCond_GMAT_MoonMJ2000EqPM_XZplane.m,v 1.3 2007/07/26 19:12:31 edove Exp $
...
GMAT StopCond_Report.Filename = ./output/AcceptTest/StopCond_GMAT_MoonMJ2000EqPM_XZplane.report;
GMAT StopCond_Report.Precision = 16;
GMAT StopCond_Report.WriteHeaders = On;
GMAT StopCond_Report.ColumnWidth = 20;

Propagate DefaultProp(DefaultSC, {DefaultSC.MoonMJ2000Eq.Y = 0.0});
Report StopCond_Report DefaultSC.A1ModJulian DefaultSC.MoonMJ2000Eq.Y;
