%% $Id: Loop_GMAT_If55.m,v 1.3 2007/07/26 19:12:30 edove Exp $
...
Create ReportFile Loop_GMAT_If55;
GMAT Loop_GMAT_If55.Filename = ./output/AcceptTest/Loop_GMAT_If55.report;
GMAT Loop_GMAT_If55.Precision = 15;
...
BeginScript;
    ...
    GMAT type = type + 1;
    GMAT ansFlag = 0;
    If SC1.A1ModJulian ~= SC1.ElapsedSecs
        GMAT ansFlag = 1;
        Propagate   DefaultProp(SC1);
    EndIf;
    Report      Loop_GMAT_If55 type ansFlag SC1.A1ModJulian SC1.ElapsedSecs SC1.TA SC1.X SC1.Y SC1.Z;
    GMAT Loop_GMAT_If55.WriteHeaders = Off;
