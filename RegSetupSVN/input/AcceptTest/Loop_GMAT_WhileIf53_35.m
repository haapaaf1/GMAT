%% $Id: Loop_GMAT_WhileIf53_35.m,v 1.3 2007/07/26 19:12:30 edove Exp $
...
Create ReportFile Loop_GMAT_WhileIf53_35;
GMAT Loop_GMAT_WhileIf53_35.Filename = ./output/AcceptTest/Loop_GMAT_WhileIf53_35.report;
GMAT Loop_GMAT_WhileIf53_35.Precision = 15;
...
BeginScript;
   ...
   While count < 5.5
        GMAT ansFlag = 0;
       If SC1.A1ModJulian == testArray(1,1)
           GMAT ansFlag = -99;
            GMAT ranOK = 0;
           Propagate   DefaultProp(SC1);
       EndIf;
        Report      Loop_GMAT_WhileIf53_35 type ansFlag ranOK SC1.A1ModJulian SC1.ElapsedSecs SC1.TA SC1.X SC1.Y SC1.Z; 
       GMAT count = count + 1;
        GMAT Loop_GMAT_WhileIf53_35.WriteHeaders = Off;
   EndWhile;
   GMAT SC1.TA = 145;
...
BeginScript;
   ...
   While count < 5.5
        GMAT ansFlag = 0;
       If testArray(1,1) == SC1.A1ModJulian
           GMAT ansFlag = -99;
            GMAT ranOK = 0;
           Propagate   DefaultProp(SC1);
       EndIf;
