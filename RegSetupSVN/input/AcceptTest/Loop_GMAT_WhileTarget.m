%% $Id: Loop_GMAT_WhileTarget.m,v 1.5 2007/09/05 14:56:30 edove Exp $

%   REVISION HISTORY
%   Author      Date            Comment
%               (MM/DD/YYYY)
%   E.Dove      07/14/2006      Original
%   E.Dove      09/05/2006      Last Modified
...
Create ReportFile Loop_GMAT_WhileTarget;
GMAT Loop_GMAT_WhileTarget.Filename = ./output/AcceptTest/Loop_GMAT_WhileTarget.report;
GMAT Loop_GMAT_WhileTarget.Precision = 15;
...
BeginScript;    
    ...
    While SC1.A1ModJulian ~= testVar
        ...
        Target DC1;
           ...
           GMAT ansFlag = 1;
           GMAT ranOK = 1;
           Report      Loop_GMAT_WhileTarget type ansFlag ranOK SC1.A1ModJulian SC1.ElapsedSecs SC1.TA SC1.SMA SC1.X SC1.Y SC1.Z;
           GMAT Loop_GMAT_WhileTarget.WriteHeaders = Off;
