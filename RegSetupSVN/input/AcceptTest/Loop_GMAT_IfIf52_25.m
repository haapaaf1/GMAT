%% $Id: Loop_GMAT_IfIf52_25.m,v 1.3 2007/07/26 19:12:30 edove Exp $
...
Create ReportFile Loop_GMAT_IfIf52_25;
GMAT Loop_GMAT_IfIf52_25.Filename = ./output/AcceptTest/Loop_GMAT_IfIf52_25.report;
GMAT Loop_GMAT_IfIf52_25.Precision = 15;
...
BeginScript;
    ...
    If testVar2 ~= 10
        ...
        EndIf;
    EndIf;
    Report      Loop_GMAT_IfIf52_25 type ansFlag SC1.A1ModJulian SC1.ElapsedSecs SC1.TA SC1.X SC1.Y SC1.Z;
    GMAT Loop_GMAT_IfIf52_25.WriteHeaders = Off;
