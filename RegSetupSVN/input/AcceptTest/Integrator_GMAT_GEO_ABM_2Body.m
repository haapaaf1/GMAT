%% $Id: Integrator_GMAT_GEO_ABM_2Body.m,v 1.4 2007/07/26 19:12:29 edove Exp $
...
Create Propagator ABM;
GMAT ABM.FM = Earth2Body;
GMAT ABM.Type = AdamsBashforthMoulton;
GMAT ABM.InitialStepSize = 60;
GMAT ABM.Accuracy = 1e-013;
GMAT ABM.MinStep = 60;
GMAT ABM.MaxStep = 60;
GMAT ABM.MaxStepAttempts = 50; 
 
GMAT SolarSystem.EphemerisUpdateInterval = 0.0;
GMAT SolarSystem.Earth.NutationUpdateInterval = 60.0; 

Create ReportFile GEO_Report
GMAT GEO_Report.Filename = ./output/AcceptTest/Integrator_GMAT_GEO_ABM_2Body.report;
...
For OutputStepSize = 1:1008;
	Propagate   ABM(GEO, {GEO.ElapsedSecs = 600});
	Report      GEO_Report GEO.A1ModJulian GEO.X GEO.Y GEO.Z GEO.VX GEO.VY GEO.VZ;
EndFor ;
