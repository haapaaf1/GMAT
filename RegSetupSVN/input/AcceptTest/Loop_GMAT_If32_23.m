%% $Id: Loop_GMAT_If32_23.m,v 1.3 2007/07/26 19:12:29 edove Exp $
...
Create ReportFile Loop_GMAT_If32_23;
GMAT Loop_GMAT_If32_23.Filename = ./output/AcceptTest/Loop_GMAT_If32_23.report;
GMAT Loop_GMAT_If32_23.Precision = 15;
...
BeginScript;
    ...
    GMAT type = type + 1;
    GMAT ansFlag = 0;
    If testArray(1,1) ~= testVar
        GMAT ansFlag = 1;
        Propagate   DefaultProp(SC1);
    EndIf;
    Report      Loop_GMAT_If32_23 type ansFlag SC1.A1ModJulian SC1.ElapsedSecs SC1.TA SC1.X SC1.Y SC1.Z;
    GMAT Loop_GMAT_If32_23.WriteHeaders = Off;
