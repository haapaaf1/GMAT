...
inputfolder = 'C:\Documents and Settings\DCrockett\Desktop\GMAT Repository\RegSetupSVN\input\SystemTest\';
outputfolder = '.\output\SystemTest\';
fname = ['FBurn_GMAT_','Jupiter_',Sc,'_',Thrst,'_CS',num2str(CSnum),'_',Tnk];
