function [] = saveExcel_1(runExcelFlag,e,eSheets,sheetExists,eWorkbooks,maxNorm2XL,DataDir,Tool1,Tool2,Tool1Folder,Tool2Folder)
...
eSheet1.set('name',[Tool1,'_',Tool2,'_PV']) %Names the sheet
