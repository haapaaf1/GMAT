function [rowStartTool1,rowStartTool2,Tool1,Tool2] = dataStart_1(Tool1Folder,Tool2Folder)
    ...
    if isempty(findstr(lower(Tool1Folder),'gmat')) == 0
        rowStartTool1 = 0; % GMAT report's first row of numerical data
        Tool1 = 'GMAT';
    ...
    if isempty(findstr(lower(Tool2Folder),'gmat')) == 0
        rowStartTool2 = 0; % GMAT report's first row of numerical data
        Tool2 = 'GMAT';
