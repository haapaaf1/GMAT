function [] = saveExcel_2(runExcelFlag,e,eSheets,sheetExists,eWorkbooks,maxDiffs2XL,DataDir,Tool1,Tool2,Tool1Folder,Tool2Folder)

% ======================== Save data into Excel ========================
eSheet2 = eSheets.get('Item', 2); %Sets an interface with the second sheet in the workbook
eSheet2.Activate; %Activates the sheet previously set to eSheet2
...
eSheet2.set('name',[Tool1,'_',Tool2,'_CS']) %Names the sheet
