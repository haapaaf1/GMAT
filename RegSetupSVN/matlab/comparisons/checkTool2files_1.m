function [reportLengthTool2,currTool1choice,currTool2choice,matchFound,charLoc1Tool2,reportFilesTool2,reportChoiceTool2] = checkTool2files_1(matchFound,Tool2Dir,Tool1,Tool2,Tool2Folder,reportLengthTool1,reportChoiceTool1,reportFilesTool1,nameFile)
%$Id: checkTool2files_1.m,v 1.2 2007/08/21 22:02:46 edove Exp $

% Check for Tool2 report files in the correct directory
cd(Tool2Dir);
countReport = 0;
...
for loop = 1:countReport
    ...
    charLoc1Tool1 = size(Tool1,2)+2; % Tool1 character location in report file after tool name
    comparePos2 = reportLengthTool1 - charLoc1Tool1; % report size from num above to last character
    charLoc1Tool2 = size(Tool2,2)+2; % Tool2 character location in report file after tool name
    ...
    if size(currTool1choice,2) == size(currTool2choice,2)
        if isempty(strmatch(currTool1choice,currTool2choice)) == 0
            matchFound = 1;
